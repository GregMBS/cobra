...
where c_cvge='".$c_cvge."' and c_cont>0 and c_msge is null
and c_cniv is null and D_FECH=last_day(curdate() - interval 2 month) + interval ".$i." day
group by D_FECH";
...
where c_cvge='".$c_cvge."' and d_fech=last_day(curdate() - interval 2 month) + interval $i day
and c_hrin>'".$TIEMPO."';";
...
from historia where  c_cvge<>'Milt' and c_cont>0 and c_msge is null
and c_cniv is null and D_FECH=last_day(curdate() - interval 2 month) + interval $i day";
...
from historia where  c_cvge<>'Milt' and c_cont>0 and c_msge is null
and c_cniv is null and D_FECH>last_day(curdate() - interval 2 month)";
