...
<body>
<button onclick="window.location='reports.php?capt=<?php echo $capt;?>'">Regressar a la plantilla administrativa</button><br>
<form action="Reporte_configurable.php" method="get" name="queryparms">
<input type="hidden" name="capt" value="<?php echo $capt ?>">
<p>Fecha:
<select name="pdate">
<?php
        $queryc = "SELECT distinct d_fech from historia
        where d_fech>curdate()-interval 3 month
        order by d_fech";
