...
status_aarsa,c_cvst,d_fech,id_cuenta,datediff(curdate(),d_prom),c_cvge 
from resumen r,historia h,fdmcs f
where c_cont=id_cuenta and n_prom>0
and status_de_credito not like '%o'
and r.cliente=f.cliente and r.numero_de_cuenta=f.numero_de_cuenta
".$gestorstr."
order by ejecutivo_asignado_call_center,cliente,status_de_credito,cuenta,d_fech desc,c_hrin desc
";
...
<html>
<head>
<title>Fin del mes Credito Si</title>
