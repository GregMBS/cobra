...
$errors=0;
if ($capt=='gmbs') {
$querytrouble="select count(1)
from trouble  
where it_guy is null
;";
$resulttrouble=mysql_query($querytrouble) or die (mysql_error());
while ($answertrouble=mysql_fetch_row($resulttrouble)) {$errors=$answertrouble[0];}
}
$fout=9999;
...
<div>
<?php 
if ($folios>0) {echo '<p><a class="butt" href="folioadmin.php?capt='.$capt.'#here0">'.$folios.' folios pendiente</a></p>';} 
if ($fout<10) {echo '<h4>Solo tenemos '.$fout.'  disponible para Credito Si</h4>';} 
