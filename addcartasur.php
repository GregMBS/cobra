...
saldo_total,cliente
FROM resumen 
where cliente='UR' and domicilio_deudor<>''
and fecha_de_actualizacion>'2009-11-30'
and id_cuenta not in 
(select c_cont from historia where c_cvst='SE MANDO CARTA' and d_fech>'2009-11-30');";
...
' CON INVITACION A DESCUENTO Y REINGRESO A UR' ;
$datebase = array("2009-12-08", "2009-12-09", "2009-12-10");
