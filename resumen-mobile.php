...
if (!empty($mytipo)) {
    ...
    $isoldid = (!empty($_REQUEST['id_cuenta']));
    if ($getupdate) {
        $find = mysqli_real_escape_string($con, $_REQUEST['find']);
        $field = mysqli_real_escape_string($con, $_REQUEST['field']);
...
AND borrado=0 AND concat(fecha,' ',hora)='" . $notalertt . "' LIMIT 1;";
    ...
    $go = mysqli_real_escape_string($con, $_REQUEST['go']);
    if ($go == 'ULTIMA') {
    ...
    if ($go == 'CAPTURADO' && !empty($_REQUEST['C_CVST'])) {
        $C_CVGE = mysqli_real_escape_string($con, $_REQUEST['C_CVGE']);
        $C_CVBA = mysqli_real_escape_string($con, $_REQUEST['C_CVBA']);
        $C_CONT = mysqli_real_escape_string($con, $_REQUEST['C_CONT']);
        $C_CONTAN = mysqli_real_escape_string($con, $_REQUEST['C_CONTAN']);
        $C_CTIPO = mysqli_real_escape_string($con, $_REQUEST['C_CTIPO']);
        $C_COWN = mysqli_real_escape_string($con, $_REQUEST['C_COWN']);
        $C_CSTAT = mysqli_real_escape_string($con, $_REQUEST['C_CSTAT']);
        $CUENTA = mysqli_real_escape_string($con, $_REQUEST['CUENTA']);
        $C_OBSE1 = utf8_decode(mysqli_real_escape_string($con, $_REQUEST['C_OBSE1']));
        $C_CALLE1 = mysqli_real_escape_string($con, $_REQUEST['C_CALLE1']);
        $C_CALLE2 = mysqli_real_escape_string($con, $_REQUEST['C_CALLE2']);
        $C_ATTE = mysqli_real_escape_string($con, $_REQUEST['C_ATTE']);
        $C_CARG = mysqli_real_escape_string($con, $_REQUEST['C_CARG']);
        $C_TELE = mysqli_real_escape_string($con, $_REQUEST['C_TELE']);
        $C_RCON = mysqli_real_escape_string($con, $_REQUEST['C_RCON']);
        $C_NSE = mysqli_real_escape_string($con, $_REQUEST['C_NSE']);
        $C_CNIV = mysqli_real_escape_string($con, $_REQUEST['C_CNIV']);
        $C_CFAC = mysqli_real_escape_string($con, $_REQUEST['C_CFAC']);
        $C_CPTA = mysqli_real_escape_string($con, $_REQUEST['C_CPTA']);
        $C_CREJ = mysqli_real_escape_string($con, $_REQUEST['C_CREJ']);
        $C_CPAT = mysqli_real_escape_string($con, $_REQUEST['C_CPAT']);
        $C_VISIT = mysqli_real_escape_string($con, $_REQUEST['C_VISIT']);
        $C_CVST = mysqli_real_escape_string($con, $_REQUEST['C_CVST']);
        $ACCION = mysqli_real_escape_string($con, $_REQUEST['ACCION']);
        $C_MOTIV = mysqli_real_escape_string($con, $_REQUEST['C_MOTIV']);
        $C_HRIN = mysqli_real_escape_string($con, $_REQUEST['C_VH']) . ':' . mysqli_real_escape_string($con, $_REQUEST['C_VMN']);
        $C_HRFI = date('H:i:s');
        $D_FECH = mysqli_real_escape_string($con, $_REQUEST['C_VD']);
        $D_PROM = mysqli_real_escape_string($con, $_REQUEST['D_PROMv']);
        $N_PROM = mysqli_real_escape_string($con, $_REQUEST['N_PROMv']);
        $D_PAGO = mysqli_real_escape_string($con, $_REQUEST['D_PAGOv']);
        $N_PAGO = mysqli_real_escape_string($con, $_REQUEST['N_PAGOv']);
        $C_PROM = mysqli_real_escape_string($con, $_REQUEST['C_PROM']);
        $C_NTEL = mysqli_real_escape_string($con, $_REQUEST['C_NTEL']);
        $C_NDIR = trim(mysqli_real_escape_string($con, $_REQUEST['C_NDIR']));
        $C_EMAIL = trim(mysqli_real_escape_string($con, $_REQUEST['C_EMAIL']));
        $C_OBSE2 = mysqli_real_escape_string($con, $_REQUEST['C_OBSE2']);
        $C_EJE = mysqli_real_escape_string($con, $_REQUEST['C_EJE']);
        if (empty($N_PROM)) {
            $N_PROM = 0;
        }
        $N_PROM = str_replace('$', '', $N_PROM);
        $C_FREQ = mysqli_real_escape_string($con, $_REQUEST['C_FREQ']);
        for ($merciv = 0; $merciv < count($_REQUEST['MERCv']); $merciv++) {
            $MERCv[$merciv] = mysqli_real_escape_string($con, $_REQUEST['MERCv'][$merciv]);
        }
...
";
    ...
    $clientestr = '';
    if (!empty($_REQUEST['clientefilt'])) {
        $clientefilt = mysqli_real_escape_string($con, $_REQUEST['clientefilt']);
