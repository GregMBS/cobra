...
folios.gestor,status_de_credito,h2.auto as upd,h1.c_prom,h1.c_freq,
...
and folios.cliente regexp 'Sales Finance'
";
...
and folios.cliente regexp 'Sales Finance' group by folio
";
...
'<input type="hidden" name="FOLIOa'+aData[1]+'" value="'+aData[1]+'">'+'<input type="submit" name="go" value="UPDATE">'+
				...
				freqh='quincenal';
			if (aData[19]*1<14) {freqh='semanal';}
			if (aData[19]*1>20) {freqh='mensual';}
			if (aData[19]='') {freqh='mensual';}
...
<p>
<button onclick="window.location='foliocreatependsf.php?capt=<?php echo $capt;?>'">CREAR PENDIENTES</button></td>
<button onclick="window.location='foliocreateallsf.php?capt=<?php echo $capt;?>'">CREAR REPORTE</button></td>
</p>
