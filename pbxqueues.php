		...
		?><tr class="dahdi"><?php
				...
				for ($j = 0; $j < count($out); $j++) {
					if (in_array($j, $colsIax)) {
						...
						if ($outs == 'from-internal-xfer') {
							$outs = 'TRANSFER';
						}
						if ($outs == 'from-internal-robot') {
							$outs = 'ROBOT';
						}
						if ($outs == 'from-pstn') {
							$outs = 'ROBOT';
						 ...
						 */
						if ($j == 11) {
							$outs		 = substr($outs, stripos($outs, "/") + 1, 4);
							$ext0[$outs]	 = 1;
						}
						echo "<td>".$outs."</td>";
					}
			...
			$colsSip = array(0, 1, 2, 6);
			if (preg_match("/^SIP/", $output[$i])) {
				?><tr class="sip"><?php
				$out	 = explode("!", $output[$i]);
				$tiempo	 = floor($out[11] / 60).':'.sprintf("%02d", ($out[11] % 60));
				for ($j = 0; $j < count($out); $j++) {
					if (in_array($j, $colsSip)) {
						$outs = $out[$j];
						if ($outs == 'from-trunk') {
							$outs = 'SALIENTE';
						}
						if ($outs == 'from-internal') {
							$outs = 'ELASTIX';
						}
						if ($outs == 'from-internal-xfer') {
							$outs = 'TRANSFER';
...
//    if ($j==0) {$outs=substr($outs,4,4);$ext[$outs]=1;}
	...
	<div style="float:left">
		...
		<tr class="ro2">
		    <td class="empty"></td>
		    <td colspan=2 style="<?php if (!empty($ext[1101])) {
				echo 'background-color:yellow;';
			}if (!empty($ext0[1101])) {
				echo
				'font-weight:bold;';
			}
			?> " id="1101"><p>1101<BR>Admon</p></td>
		...
		<tr class="ro1">
		    <td style=" " class="empty"></td>
		    <td style=" <?php if (!empty($ext[1005])) {
				echo 'background-color:yellow;';
			}if (!empty($ext0[1005])) {
				echo
				'font-weight:bold;';
			...
			?> " id="1005"><p>1005</p></td>
		    <td style=" <?php if (!empty($ext[1010])) {
				echo 'background-color:yellow;';
			}if (!empty($ext0[1010])) {
				echo
				'font-weight:bold;';
		...
		<tr class="ro1">
		    <td style=" " class="empty"></td>
		    <td style=" <?php if (!empty($ext[1004])) {
				echo 'background-color:yellow;';
			}if (!empty($ext0[1004])) {
				echo
				'font-weight:bold;';
			...
			?> " id="1004"><p>1004</p></td>
		    <td style=" <?php if (!empty($ext[1009])) {
				echo 'background-color:yellow;';
			}if (!empty($ext0[1009])) {
				echo
				'font-weight:bold;';
		...
		<tr class="ro1">
		    <td style=" " class="empty"></td>
		    <td style=" <?php if (!empty($ext[1003])) {
				echo 'background-color:yellow;';
			}if (!empty($ext0[1003])) {
				echo
				'font-weight:bold;';
			...
			?> " id="1003"><p>1003</p></td>
		    <td style=" <?php if (!empty($ext[1008])) {
				echo 'background-color:yellow;';
			}if (!empty($ext0[1008])) {
				echo
				'font-weight:bold;';
		...
		<tr class="ro1">
		    <td style=" " class="empty"></td>
		    <td style=" <?php if (!empty($ext[1002])) {
				echo 'background-color:yellow;';
			}if (!empty($ext0[1002])) {
				echo
				'font-weight:bold;';
			...
			?> " id="1002"><p>1002</p></td>
		    <td style=" <?php if (!empty($ext[1007])) {
				echo 'background-color:yellow;';
			}if (!empty($ext0[1007])) {
				echo
				'font-weight:bold;';
		...
		<tr class="ro1">
		    <td style=" " class="empty"></td>
		    <td style=" <?php if (!empty($ext[1001])) {
				echo 'background-color:yellow;';
			}if (!empty($ext0[1001])) {
				echo
				'font-weight:bold;';
			...
			?> " id="1001"><p>1001</p></td>
		    <td style=" <?php if (!empty($ext[1006])) {
				echo 'background-color:yellow;';
			}if (!empty($ext0[1006])) {
				echo
				'font-weight:bold;';
