...
AND fecha<last_day(curdate() - interval 1 month) + interval 14 day
and status_de_credito='';";
$i=0;
...
AND d_fech<last_day(curdate() - interval 1 month) + interval 14 day
and cliente='Surtidor del Hogar'  and c_cniv is null
and c_cvge<>'Milt';";
