...
$querymain = "select distinct nombre_deudor,numero_de_cuenta,
    ...
    tel_1_ref_3)))) as t1_ref_3,
    saldo_total,id_cuenta,nombre_referencia_3,status_de_credito,status_aarsa
 from resumen left join historia on c_cont=id_cuenta and right(c_tele,8)=right(tel_1_ref_3,8)
where auto is null and cliente='".$cliente."' 
and status_de_credito not like '%o'
having length(t1_ref_3) in (8,12)
    ;";
