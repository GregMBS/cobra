...
$querygable="SELECT id_cuenta, numero_de_cuenta,tel_1,'eduardo',cliente
from resumen 
where (cliente='GE Capital')
and status_de_credito not like '%o'
and not exists (select c_cont from historia 
where resumen.id_cuenta=historia.c_cont and d_fech>='2010-12-01')
;";
...
//$D_FECHa=array("2010-12-09","2010-12-10","2010-12-11","2010-12-12");
$D_FECH="2010-12-".str_pad(rand(0,29)+1, 2, "0", STR_PAD_LEFT);
$hour=0;
while ($hour==0) {
