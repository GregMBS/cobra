...
sucursal_cliente as 'campa&ntilde;a',producto,subproducto,q(status_aarsa) as 'queue',status_aarsa,
...
and pagos.fecha between least(d_fech + interval 1 hour,d_prom1) and greatest(d_prom1,d_prom2)
...
and pagos.fecha between least(h3.d_fech + interval 1 hour,d_prom1) and greatest(d_prom1,d_prom2)
