...
/**
 * Base class that represents a row from the 'resumen' table.
 *
 *
 *
 * @package    propel.generator.cobra.om
 */
abstract class BaseResumen extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'ResumenPeer';
    ...
    /**
     * The value for the avapar field.
     * @var        string
     */
    protected $avapar;
    ...
    /**
     * The value for the domicilio_deudor_2 field.
     * @var        string
     */
    protected $domicilio_deudor_2;
    ...
    /**
     * The value for the originacion field.
     * @var        string
     */
    protected $originacion;
    ...
    /**
     * The value for the fecha_convenio field.
     * @var        string
     */
    protected $fecha_convenio;
    ...
    /**
     * Initializes internal state of BaseResumen object.
     * @see        applyDefaults()
     */
    ...
    /**
     * Get the [avapar] column value.
     *
     * @return string
     */
    public function getAvapar()
    {
        return $this->avapar;
    }
    ...
    /**
     * Get the [domicilio_deudor_2] column value.
     *
     * @return string
     */
    public function getDomicilioDeudor2()
    {
        return $this->domicilio_deudor_2;
    }
    ...
    /**
     * Get the [originacion] column value.
     *
     * @return string
     */
    public function getOriginacion()
    {
        return $this->originacion;
    }
    ...
    /**
     * Get the [nrpp] column value.
     *
     * @return string
     */
    public function getNrpp()
    {
        return $this->nrpp;
    }
    ...
    /**
     * Get the [optionally formatted] temporal [fecha_convenio] column value.
     *
     *
     * @param string $format The date/time format string (either date()-style or strftime()-style).
     *				 If format is null, then the raw DateTime object will be returned.
     ...
     * @throws PropelException - if unable to parse/validate the date/time value.
     */
    public function getFechaConvenio($format = '%F')
    {
        if ($this->fecha_convenio === null) {
            return null;
        }

        if ($this->fecha_convenio === '0000-00-00') {
            // while technically this is not a default value of null,
            // this seems to be closest in meaning.
            return null;
        }
        ...
        try {
            $dt = new DateTime($this->fecha_convenio);
        } catch (Exception $x) {
            throw new PropelException("Internally stored date/time/timestamp value could not be converted to DateTime: " . var_export($this->fecha_convenio, true), $x);
        }
     ...
     * @return Resumen The current object (for fluent API support)
     */
    public function setNombreDeudor($v)
    {
        ...
        if ($this->nombre_deudor !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::NOMBRE_DEUDOR;
        }
    ...
    public function setDomicilioDeudor($v)
    {
        ...
        if ($this->domicilio_deudor !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::DOMICILIO_DEUDOR;
        }
    ...
    public function setColoniaDeudor($v)
    {
        ...
        if ($this->colonia_deudor !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::COLONIA_DEUDOR;
        }
    ...
    public function setCiudadDeudor($v)
    {
        ...
        if ($this->ciudad_deudor !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::CIUDAD_DEUDOR;
        }
    ...
    public function setEstadoDeudor($v)
    {
        ...
        if ($this->estado_deudor !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::ESTADO_DEUDOR;
        }
    ...
    public function setCpDeudor($v)
    {
        ...
        if ($this->cp_deudor !== $v) {
            $this->cp_deudor = $v;
            $this->modifiedColumns[] = ResumenPeer::CP_DEUDOR;
        }
    ...
    public function setPlanoGuiaRoji($v)
    {
        ...
        if ($this->plano_guia_roji !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::PLANO_GUIA_ROJI;
        }
    ...
    public function setCuadranteGuiaRoji($v)
    {
        ...
        if ($this->cuadrante_guia_roji !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::CUADRANTE_GUIA_ROJI;
        }
    ...
    public function setTel1($v)
    {
        ...
        if ($this->tel_1 !== $v) {
            $this->tel_1 = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_1;
        }
    ...
    public function setTel2($v)
    {
        ...
        if ($this->tel_2 !== $v) {
            $this->tel_2 = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_2;
        }
    ...
    public function setTel3($v)
    {
        ...
        if ($this->tel_3 !== $v) {
            $this->tel_3 = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_3;
        }
    ...
    public function setTel4($v)
    {
        ...
        if ($this->tel_4 !== $v) {
            $this->tel_4 = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_4;
        }
    ...
    public function setNombreDeudorAlterno($v)
    {
        ...
        if ($this->nombre_deudor_alterno !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::NOMBRE_DEUDOR_ALTERNO;
        }
    ...
    public function setDomicilioDeudorAlterno($v)
    {
        ...
        if ($this->domicilio_deudor_alterno !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::DOMICILIO_DEUDOR_ALTERNO;
        }
    ...
    public function setColoniaDeudorAlterno($v)
    {
        ...
        if ($this->colonia_deudor_alterno !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::COLONIA_DEUDOR_ALTERNO;
        }
    ...
    public function setCiudadDeudorAlterno($v)
    {
        ...
        if ($this->ciudad_deudor_alterno !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::CIUDAD_DEUDOR_ALTERNO;
        }
    ...
    public function setEstadoDeudorAlterno($v)
    {
        ...
        if ($this->estado_deudor_alterno !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::ESTADO_DEUDOR_ALTERNO;
        }
    ...
    public function setCpDeudorAterno($v)
    {
        ...
        if ($this->cp_deudor_aterno !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::CP_DEUDOR_ATERNO;
        }
    ...
    public function setTel1Alterno($v)
    {
        ...
        if ($this->tel_1_alterno !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::TEL_1_ALTERNO;
        }
    ...
    public function setTel2Alterno($v)
    {
        ...
        if ($this->tel_2_alterno !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::TEL_2_ALTERNO;
        }
    ...
    public function setTel3Alterno($v)
    {
        ...
        if ($this->tel_3_alterno !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::TEL_3_ALTERNO;
        }
    ...
    public function setTel4Alterno($v)
    {
        ...
        if ($this->tel_4_alterno !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::TEL_4_ALTERNO;
        }
    ...
    public function setPlanoGuiaRojiAlterno($v)
    {
        ...
        if ($this->plano_guia_roji_alterno !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::PLANO_GUIA_ROJI_ALTERNO;
        }
    ...
    public function setCuadranteGuiaRojiAlterno($v)
    {
        ...
        if ($this->cuadrante_guia_roji_alterno !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::CUADRANTE_GUIA_ROJI_ALTERNO;
        }
    ...
    public function setStatusAarsa($v)
    {
        ...
        if ($this->status_aarsa !== $v) {
            $this->status_aarsa = $v;
            $this->modifiedColumns[] = ResumenPeer::STATUS_AARSA;
        }
    ...
    /**
     * Set the value of [avapar] column.
     *
     * @param string $v new value
     * @return Resumen The current object (for fluent API support)
     */
    public function setAvapar($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->avapar !== $v) {
            $this->avapar = $v;
            $this->modifiedColumns[] = ResumenPeer::AVAPAR;
        }
    ...
    public function setParentescoRef1($v)
    {
        ...
        if ($this->parentesco_ref_1 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::PARENTESCO_REF_1;
        }
    ...
    public function setNombreReferencia1($v)
    {
        ...
        if ($this->nombre_referencia_1 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::NOMBRE_REFERENCIA_1;
        }
    ...
    public function setDomicilioReferencia1($v)
    {
        ...
        if ($this->domicilio_referencia_1 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::DOMICILIO_REFERENCIA_1;
        }
    ...
    public function setColoniaReferencia1($v)
    {
        ...
        if ($this->colonia_referencia_1 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::COLONIA_REFERENCIA_1;
        }
    ...
    public function setCiudadReferencia1($v)
    {
        ...
        if ($this->ciudad_referencia_1 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::CIUDAD_REFERENCIA_1;
        }
    ...
    public function setEstadoReferencia1($v)
    {
        ...
        if ($this->estado_referencia_1 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::ESTADO_REFERENCIA_1;
        }
    ...
    public function setCpReferencia1($v)
    {
        ...
        if ($this->cp_referencia_1 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::CP_REFERENCIA_1;
        }
    ...
    public function setTel1Ref1($v)
    {
        ...
        if ($this->tel_1_ref_1 !== $v) {
            $this->tel_1_ref_1 = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_1_REF_1;
        }
    ...
    public function setTel2Ref1($v)
    {
        ...
        if ($this->tel_2_ref_1 !== $v) {
            $this->tel_2_ref_1 = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_2_REF_1;
        }
    ...
    public function setParentescoRef2($v)
    {
        ...
        if ($this->parentesco_ref_2 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::PARENTESCO_REF_2;
        }
    ...
    public function setNombreReferencia2($v)
    {
        ...
        if ($this->nombre_referencia_2 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::NOMBRE_REFERENCIA_2;
        }
    ...
    public function setDomicilioReferencia2($v)
    {
        ...
        if ($this->domicilio_referencia_2 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::DOMICILIO_REFERENCIA_2;
        }
    ...
    public function setColoniaReferencia2($v)
    {
        ...
        if ($this->colonia_referencia_2 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::COLONIA_REFERENCIA_2;
        }
    ...
    public function setCiudadReferencia2($v)
    {
        ...
        if ($this->ciudad_referencia_2 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::CIUDAD_REFERENCIA_2;
        }
    ...
    public function setEstadoReferencia2($v)
    {
        ...
        if ($this->estado_referencia_2 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::ESTADO_REFERENCIA_2;
        }
    ...
    public function setCpReferencia2($v)
    {
        ...
        if ($this->cp_referencia_2 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::CP_REFERENCIA_2;
        }
    ...
    public function setTel1Ref2($v)
    {
        ...
        if ($this->tel_1_ref_2 !== $v) {
            $this->tel_1_ref_2 = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_1_REF_2;
        }
    ...
    public function setTel2Ref2($v)
    {
        ...
        if ($this->tel_2_ref_2 !== $v) {
            $this->tel_2_ref_2 = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_2_REF_2;
        }
    ...
    public function setParentescoRef3($v)
    {
        ...
        if ($this->parentesco_ref_3 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::PARENTESCO_REF_3;
        }
    ...
    public function setNombreReferencia3($v)
    {
        ...
        if ($this->nombre_referencia_3 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::NOMBRE_REFERENCIA_3;
        }
    ...
    public function setDomicilioReferencia3($v)
    {
        ...
        if ($this->domicilio_referencia_3 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::DOMICILIO_REFERENCIA_3;
        }
    ...
    public function setColoniaReferencia3($v)
    {
        ...
        if ($this->colonia_referencia_3 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::COLONIA_REFERENCIA_3;
        }
    ...
    public function setCiudadReferencia3($v)
    {
        ...
        if ($this->ciudad_referencia_3 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::CIUDAD_REFERENCIA_3;
        }
    ...
    public function setEstadoReferencia3($v)
    {
        ...
        if ($this->estado_referencia_3 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::ESTADO_REFERENCIA_3;
        }
    ...
    public function setCpReferencia3($v)
    {
        ...
        if ($this->cp_referencia_3 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::CP_REFERENCIA_3;
        }
    ...
    public function setTel1Ref3($v)
    {
        ...
        if ($this->tel_1_ref_3 !== $v) {
            $this->tel_1_ref_3 = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_1_REF_3;
        }
    ...
    public function setTel2Ref3($v)
    {
        ...
        if ($this->tel_2_ref_3 !== $v) {
            $this->tel_2_ref_3 = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_2_REF_3;
        }
    ...
    public function setParentescoRef4($v)
    {
        ...
        if ($this->parentesco_ref_4 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::PARENTESCO_REF_4;
        }
    ...
    public function setNombreReferencia4($v)
    {
        ...
        if ($this->nombre_referencia_4 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::NOMBRE_REFERENCIA_4;
        }
    ...
    /**
     * Set the value of [domicilio_deudor_2] column.
     *
     * @param string $v new value
     * @return Resumen The current object (for fluent API support)
     */
    public function setDomicilioDeudor2($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->domicilio_deudor_2 !== $v) {
            $this->domicilio_deudor_2 = $v;
            $this->modifiedColumns[] = ResumenPeer::DOMICILIO_DEUDOR_2;
        }
    ...
    public function setFrecuencia($v)
    {
        ...
        if ($this->frecuencia !== $v) {
            $this->frecuencia = $v;
            $this->modifiedColumns[] = ResumenPeer::FRECUENCIA;
        }
    ...
    /**
     * Set the value of [originacion] column.
     *
     * @param string $v new value
     * @return Resumen The current object (for fluent API support)
     */
    public function setOriginacion($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->originacion !== $v) {
            $this->originacion = $v;
            $this->modifiedColumns[] = ResumenPeer::ORIGINACION;
        }
    ...
    public function setSucursalCliente($v)
    {
        ...
        if ($this->sucursal_cliente !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::SUCURSAL_CLIENTE;
        }
    ...
    public function setCpReferencia4($v)
    {
        ...
        if ($this->cp_referencia_4 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::CP_REFERENCIA_4;
        }
    ...
    public function setTel1Ref4($v)
    {
        ...
        if ($this->tel_1_ref_4 !== $v) {
            $this->tel_1_ref_4 = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_1_REF_4;
        }
    ...
    public function setTel2Ref4($v)
    {
        ...
        if ($this->tel_2_ref_4 !== $v) {
            $this->tel_2_ref_4 = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_2_REF_4;
        }
    ...
    public function setDomicilioLaboral($v)
    {
        ...
        if ($this->domicilio_laboral !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::DOMICILIO_LABORAL;
        }
    ...
    public function setColoniaLaboral($v)
    {
        ...
        if ($this->colonia_laboral !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::COLONIA_LABORAL;
        }
    ...
    public function setCiudadLaboral($v)
    {
        ...
        if ($this->ciudad_laboral !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::CIUDAD_LABORAL;
        }
    ...
    public function setEstadoLaboral($v)
    {
        ...
        if ($this->estado_laboral !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::ESTADO_LABORAL;
        }
    ...
    public function setCpLaboral($v)
    {
        ...
        if ($this->cp_laboral !== $v) {
            $this->cp_laboral = $v;
            $this->modifiedColumns[] = ResumenPeer::CP_LABORAL;
        }
    ...
    public function setTel1Laboral($v)
    {
        ...
        if ($this->tel_1_laboral !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::TEL_1_LABORAL;
        }
    ...
    public function setTel2Laboral($v)
    {
        ...
        if ($this->tel_2_laboral !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::TEL_2_LABORAL;
        }
    ...
    public function setSaldoCorriente($v)
    {
        ...
        if ($this->saldo_corriente !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::SALDO_CORRIENTE;
        }
    ...
    public function setFechaDeActualizacion($v)
    {
        ...
        if ($this->fecha_de_actualizacion !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ResumenPeer::FECHA_DE_ACTUALIZACION;
            }
    ...
    public function setNumeroDeCuenta($v)
    {
        ...
        if ($this->numero_de_cuenta !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::NUMERO_DE_CUENTA;
        }
    ...
    public function setNumeroDeCredito($v)
    {
        ...
        if ($this->numero_de_credito !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::NUMERO_DE_CREDITO;
        }
    ...
    public function setContrato($v)
    {
        ...
        if ($this->contrato !== $v) {
            $this->contrato = $v;
            $this->modifiedColumns[] = ResumenPeer::CONTRATO;
        }
    ...
    public function setSaldoTotal($v)
    {
        ...
        if ($this->saldo_total !== $v) {
            $this->saldo_total = $v;
            $this->modifiedColumns[] = ResumenPeer::SALDO_TOTAL;
        }
    ...
    public function setSaldoVencido($v)
    {
        ...
        if ($this->saldo_vencido !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::SALDO_VENCIDO;
        }
    ...
    public function setSaldoDescuento1($v)
    {
        ...
        if ($this->saldo_descuento_1 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::SALDO_DESCUENTO_1;
        }
    ...
    public function setSaldoDescuento2($v)
    {
        ...
        if ($this->saldo_descuento_2 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::SALDO_DESCUENTO_2;
        }
    ...
    public function setFechaCorte($v)
    {
        ...
        if ($this->fecha_corte !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ResumenPeer::FECHA_CORTE;
            }
        } // if either are not null
    ...
    public function setFechaLimite($v)
    {
        ...
        if ($this->fecha_limite !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ResumenPeer::FECHA_LIMITE;
            }
        } // if either are not null
    ...
    public function setFechaDeUltimoPago($v)
    {
        ...
        if ($this->fecha_de_ultimo_pago !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ResumenPeer::FECHA_DE_ULTIMO_PAGO;
            }
        } // if either are not null
    ...
    public function setMontoUltimoPago($v)
    {
        ...
        if ($this->monto_ultimo_pago !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::MONTO_ULTIMO_PAGO;
        }
    ...
    public function setProducto($v)
    {
        ...
        if ($this->producto !== $v) {
            $this->producto = $v;
            $this->modifiedColumns[] = ResumenPeer::PRODUCTO;
        }
    ...
    public function setSubproducto($v)
    {
        ...
        if ($this->subproducto !== $v) {
            $this->subproducto = $v;
            $this->modifiedColumns[] = ResumenPeer::SUBPRODUCTO;
        }
    ...
    public function setCliente($v)
    {
        ...
        if ($this->cliente !== $v) {
            $this->cliente = $v;
            $this->modifiedColumns[] = ResumenPeer::CLIENTE;
        }
    ...
    public function setStatusDeCredito($v)
    {
        ...
        if ($this->status_de_credito !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::STATUS_DE_CREDITO;
        }
    ...
    public function setPagosVencidos($v)
    {
        ...
        if ($this->pagos_vencidos !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::PAGOS_VENCIDOS;
        }
    ...
    public function setMontoAdeudado($v)
    {
        ...
        if ($this->monto_adeudado !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::MONTO_ADEUDADO;
        }
    ...
    public function setFechaDeAsignacion($v)
    {
        ...
        if ($this->fecha_de_asignacion !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ResumenPeer::FECHA_DE_ASIGNACION;
            }
        } // if either are not null
    ...
    public function setFechaDeDeasignacion($v)
    {
        ...
        if ($this->fecha_de_deasignacion !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ResumenPeer::FECHA_DE_DEASIGNACION;
            }
        } // if either are not null
    ...
    public function setCuentaConcentradora1($v)
    {
        ...
        if ($this->cuenta_concentradora_1 !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::CUENTA_CONCENTRADORA_1;
        }
    ...
    public function setSaldoCuota($v)
    {
        ...
        if ($this->saldo_cuota !== $v) {
            $this->saldo_cuota = $v;
            $this->modifiedColumns[] = ResumenPeer::SALDO_CUOTA;
        }
    ...
    public function setEmailDeudor($v)
    {
        ...
        if ($this->email_deudor !== $v) {
            $this->email_deudor = $v;
            $this->modifiedColumns[] = ResumenPeer::EMAIL_DEUDOR;
        }
    ...
    public function setIdCuenta($v)
    {
        ...
        if ($this->id_cuenta !== $v) {
            $this->id_cuenta = $v;
            $this->modifiedColumns[] = ResumenPeer::ID_CUENTA;
        }
    ...
    public function setNss($v)
    {
        ...
        if ($this->nss !== $v) {
            $this->nss = $v;
            $this->modifiedColumns[] = ResumenPeer::NSS;
        }
    ...
    public function setRfcDeudor($v)
    {
        ...
        if ($this->rfc_deudor !== $v) {
            $this->rfc_deudor = $v;
            $this->modifiedColumns[] = ResumenPeer::RFC_DEUDOR;
        }
    ...
    public function setTelefonosMarcados($v)
    {
        ...
        if ($this->telefonos_marcados !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::TELEFONOS_MARCADOS;
        }
    ...
    public function setTel1Verif($v)
    {
        ...
        if ($this->tel_1_verif !== $v) {
            $this->tel_1_verif = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_1_VERIF;
        }
    ...
    public function setTel2Verif($v)
    {
        ...
        if ($this->tel_2_verif !== $v) {
            $this->tel_2_verif = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_2_VERIF;
        }
    ...
    public function setTel3Verif($v)
    {
        ...
        if ($this->tel_3_verif !== $v) {
            $this->tel_3_verif = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_3_VERIF;
        }
    ...
    public function setTel4Verif($v)
    {
        ...
        if ($this->tel_4_verif !== $v) {
            $this->tel_4_verif = $v;
            $this->modifiedColumns[] = ResumenPeer::TEL_4_VERIF;
        }
    ...
    public function setTelefonoDeUltimoContacto($v)
    {
        ...
        if ($this->telefono_de_ultimo_contacto !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::TELEFONO_DE_ULTIMO_CONTACTO;
        }
    ...
    public function setDiasVencidos($v)
    {
        ...
        if ($this->dias_vencidos !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::DIAS_VENCIDOS;
        }
    ...
    public function setEjecutivoAsignadoCallCenter($v)
    {
        ...
        if ($this->ejecutivo_asignado_call_center !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::EJECUTIVO_ASIGNADO_CALL_CENTER;
        }
    ...
    public function setEjecutivoAsignadoDomiciliario($v)
    {
        ...
        if ($this->ejecutivo_asignado_domiciliario !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::EJECUTIVO_ASIGNADO_DOMICILIARIO;
        }
    ...
    public function setPrioridadDeGestion($v)
    {
        ...
        if ($this->prioridad_de_gestion !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::PRIORIDAD_DE_GESTION;
        }
    ...
    /**
     * Set the value of [nrpp] column.
     *
     * @param string $v new value
     * @return Resumen The current object (for fluent API support)
     */
    public function setNrpp($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }
        ...
        if ($this->nrpp !== $v) {
            $this->nrpp = $v;
            $this->modifiedColumns[] = ResumenPeer::NRPP;
        }
    ...
    public function setParentescoAval($v)
    {
        ...
        if ($this->parentesco_aval !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::PARENTESCO_AVAL;
        }
    ...
    public function setLocalizar($v)
    {
        ...
        if ($this->localizar !== $v) {
            $this->localizar = $v;
            $this->modifiedColumns[] = ResumenPeer::LOCALIZAR;
        }
    ...
    public function setFechaUltimaGestion($v)
    {
        ...
        if ($this->fecha_ultima_gestion !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = ResumenPeer::FECHA_ULTIMA_GESTION;
            }
        } // if either are not null
    ...
    public function setEmpresa($v)
    {
        ...
        if ($this->empresa !== $v) {
            $this->empresa = $v;
            $this->modifiedColumns[] = ResumenPeer::EMPRESA;
        }
    ...
    public function setTimelock($v)
    {
        ...
        if ($this->timelock !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = ResumenPeer::TIMELOCK;
            }
        } // if either are not null
    ...
    public function setLocker($v)
    {
        ...
        if ($this->locker !== $v) {
            $this->locker = $v;
            $this->modifiedColumns[] = ResumenPeer::LOCKER;
        }
    ...
    /**
     * Sets the value of [fecha_convenio] column to a normalized version of the date/time value specified.
     *
     * @param mixed $v string, integer (timestamp), or DateTime value.
     *               Empty strings are treated as null.
     * @return Resumen The current object (for fluent API support)
     */
    public function setFechaConvenio($v)
    {
        $dt = PropelDateTime::newInstance($v, null, 'DateTime');
        if ($this->fecha_convenio !== null || $dt !== null) {
            $currentDateAsString = ($this->fecha_convenio !== null && $tmpDt = new DateTime($this->fecha_convenio)) ? $tmpDt->format('Y-m-d') : null;
            $newDateAsString = $dt ? $dt->format('Y-m-d') : null;
            if ($currentDateAsString !== $newDateAsString) {
                $this->fecha_convenio = $newDateAsString;
                $this->modifiedColumns[] = ResumenPeer::FECHA_CONVENIO;
            }
        } // if either are not null
    ...
    public function setEspecial($v)
    {
        ...
        if ($this->especial !== $v) {
            $this->especial = $v;
            $this->modifiedColumns[] = ResumenPeer::ESPECIAL;
        }
    ...
    public function setDireccionNueva($v)
    {
        ...
        if ($this->direccion_nueva !== $v) {
            ...
            $this->modifiedColumns[] = ResumenPeer::DIRECCION_NUEVA;
        }
    ...
    public function setNorobot($v)
    {
        ...
        if ($this->norobot !== null || $dt !== null) {
            ...
            if ( ($currentDateAsString !== $newDateAsString) // normalized values don't match
                ...
                $this->modifiedColumns[] = ResumenPeer::NOROBOT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->avapar = ($row[$startcol + 25] !== null) ? (string) $row[$startcol + 25] : null;
            ...
            $this->domicilio_deudor_2 = ($row[$startcol + 55] !== null) ? (string) $row[$startcol + 55] : null;
            $this->frecuencia = ($row[$startcol + 56] !== null) ? (string) $row[$startcol + 56] : null;
            $this->originacion = ($row[$startcol + 57] !== null) ? (string) $row[$startcol + 57] : null;
            $this->sucursal_cliente = ($row[$startcol + 58] !== null) ? (string) $row[$startcol + 58] : null;
            ...
            $this->nss = ($row[$startcol + 94] !== null) ? (string) $row[$startcol + 94] : null;
            ...
            $this->nrpp = ($row[$startcol + 106] !== null) ? (string) $row[$startcol + 106] : null;
            ...
            $this->fecha_convenio = ($row[$startcol + 113] !== null) ? (string) $row[$startcol + 113] : null;
            ...
            return $startcol + 117; // 117 = ResumenPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Resumen object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ResumenPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ResumenQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ResumenPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ResumenPeer::NOMBRE_DEUDOR)) {
            $modifiedColumns[':p' . $index++]  = '`nombre_deudor`';
        }
        if ($this->isColumnModified(ResumenPeer::DOMICILIO_DEUDOR)) {
            $modifiedColumns[':p' . $index++]  = '`domicilio_deudor`';
        }
        if ($this->isColumnModified(ResumenPeer::COLONIA_DEUDOR)) {
            $modifiedColumns[':p' . $index++]  = '`colonia_deudor`';
        }
        if ($this->isColumnModified(ResumenPeer::CIUDAD_DEUDOR)) {
            $modifiedColumns[':p' . $index++]  = '`ciudad_deudor`';
        }
        if ($this->isColumnModified(ResumenPeer::ESTADO_DEUDOR)) {
            $modifiedColumns[':p' . $index++]  = '`estado_deudor`';
        }
        if ($this->isColumnModified(ResumenPeer::CP_DEUDOR)) {
            $modifiedColumns[':p' . $index++]  = '`cp_deudor`';
        }
        if ($this->isColumnModified(ResumenPeer::PLANO_GUIA_ROJI)) {
            $modifiedColumns[':p' . $index++]  = '`plano_guia_roji`';
        }
        if ($this->isColumnModified(ResumenPeer::CUADRANTE_GUIA_ROJI)) {
            $modifiedColumns[':p' . $index++]  = '`cuadrante_guia_roji`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_1)) {
            $modifiedColumns[':p' . $index++]  = '`tel_1`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_2)) {
            $modifiedColumns[':p' . $index++]  = '`tel_2`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_3)) {
            $modifiedColumns[':p' . $index++]  = '`tel_3`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_4)) {
            $modifiedColumns[':p' . $index++]  = '`tel_4`';
        }
        if ($this->isColumnModified(ResumenPeer::NOMBRE_DEUDOR_ALTERNO)) {
            $modifiedColumns[':p' . $index++]  = '`nombre_deudor_alterno`';
        }
        if ($this->isColumnModified(ResumenPeer::DOMICILIO_DEUDOR_ALTERNO)) {
            $modifiedColumns[':p' . $index++]  = '`domicilio_deudor_alterno`';
        }
        if ($this->isColumnModified(ResumenPeer::COLONIA_DEUDOR_ALTERNO)) {
            $modifiedColumns[':p' . $index++]  = '`colonia_deudor_alterno`';
        }
        if ($this->isColumnModified(ResumenPeer::CIUDAD_DEUDOR_ALTERNO)) {
            $modifiedColumns[':p' . $index++]  = '`ciudad_deudor_alterno`';
        }
        if ($this->isColumnModified(ResumenPeer::ESTADO_DEUDOR_ALTERNO)) {
            $modifiedColumns[':p' . $index++]  = '`estado_deudor_alterno`';
        }
        if ($this->isColumnModified(ResumenPeer::CP_DEUDOR_ATERNO)) {
            $modifiedColumns[':p' . $index++]  = '`cp_deudor_aterno`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_1_ALTERNO)) {
            $modifiedColumns[':p' . $index++]  = '`tel_1_alterno`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_2_ALTERNO)) {
            $modifiedColumns[':p' . $index++]  = '`tel_2_alterno`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_3_ALTERNO)) {
            $modifiedColumns[':p' . $index++]  = '`tel_3_alterno`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_4_ALTERNO)) {
            $modifiedColumns[':p' . $index++]  = '`tel_4_alterno`';
        }
        if ($this->isColumnModified(ResumenPeer::PLANO_GUIA_ROJI_ALTERNO)) {
            $modifiedColumns[':p' . $index++]  = '`plano_guia_roji_alterno`';
        }
        if ($this->isColumnModified(ResumenPeer::CUADRANTE_GUIA_ROJI_ALTERNO)) {
            $modifiedColumns[':p' . $index++]  = '`cuadrante_guia_roji_alterno`';
        }
        if ($this->isColumnModified(ResumenPeer::STATUS_AARSA)) {
            $modifiedColumns[':p' . $index++]  = '`status_aarsa`';
        }
        if ($this->isColumnModified(ResumenPeer::AVAPAR)) {
            $modifiedColumns[':p' . $index++]  = '`avapar`';
        }
        if ($this->isColumnModified(ResumenPeer::PARENTESCO_REF_1)) {
            $modifiedColumns[':p' . $index++]  = '`parentesco_ref_1`';
        }
        if ($this->isColumnModified(ResumenPeer::NOMBRE_REFERENCIA_1)) {
            $modifiedColumns[':p' . $index++]  = '`nombre_referencia_1`';
        }
        if ($this->isColumnModified(ResumenPeer::DOMICILIO_REFERENCIA_1)) {
            $modifiedColumns[':p' . $index++]  = '`domicilio_referencia_1`';
        }
        if ($this->isColumnModified(ResumenPeer::COLONIA_REFERENCIA_1)) {
            $modifiedColumns[':p' . $index++]  = '`colonia_referencia_1`';
        }
        if ($this->isColumnModified(ResumenPeer::CIUDAD_REFERENCIA_1)) {
            $modifiedColumns[':p' . $index++]  = '`ciudad_referencia_1`';
        }
        if ($this->isColumnModified(ResumenPeer::ESTADO_REFERENCIA_1)) {
            $modifiedColumns[':p' . $index++]  = '`estado_referencia_1`';
        }
        if ($this->isColumnModified(ResumenPeer::CP_REFERENCIA_1)) {
            $modifiedColumns[':p' . $index++]  = '`cp_referencia_1`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_1_REF_1)) {
            $modifiedColumns[':p' . $index++]  = '`tel_1_ref_1`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_2_REF_1)) {
            $modifiedColumns[':p' . $index++]  = '`tel_2_ref_1`';
        }
        if ($this->isColumnModified(ResumenPeer::PARENTESCO_REF_2)) {
            $modifiedColumns[':p' . $index++]  = '`parentesco_ref_2`';
        }
        if ($this->isColumnModified(ResumenPeer::NOMBRE_REFERENCIA_2)) {
            $modifiedColumns[':p' . $index++]  = '`nombre_referencia_2`';
        }
        if ($this->isColumnModified(ResumenPeer::DOMICILIO_REFERENCIA_2)) {
            $modifiedColumns[':p' . $index++]  = '`domicilio_referencia_2`';
        }
        if ($this->isColumnModified(ResumenPeer::COLONIA_REFERENCIA_2)) {
            $modifiedColumns[':p' . $index++]  = '`colonia_referencia_2`';
        }
        if ($this->isColumnModified(ResumenPeer::CIUDAD_REFERENCIA_2)) {
            $modifiedColumns[':p' . $index++]  = '`ciudad_referencia_2`';
        }
        if ($this->isColumnModified(ResumenPeer::ESTADO_REFERENCIA_2)) {
            $modifiedColumns[':p' . $index++]  = '`estado_referencia_2`';
        }
        if ($this->isColumnModified(ResumenPeer::CP_REFERENCIA_2)) {
            $modifiedColumns[':p' . $index++]  = '`cp_referencia_2`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_1_REF_2)) {
            $modifiedColumns[':p' . $index++]  = '`tel_1_ref_2`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_2_REF_2)) {
            $modifiedColumns[':p' . $index++]  = '`tel_2_ref_2`';
        }
        if ($this->isColumnModified(ResumenPeer::PARENTESCO_REF_3)) {
            $modifiedColumns[':p' . $index++]  = '`parentesco_ref_3`';
        }
        if ($this->isColumnModified(ResumenPeer::NOMBRE_REFERENCIA_3)) {
            $modifiedColumns[':p' . $index++]  = '`nombre_referencia_3`';
        }
        if ($this->isColumnModified(ResumenPeer::DOMICILIO_REFERENCIA_3)) {
            $modifiedColumns[':p' . $index++]  = '`domicilio_referencia_3`';
        }
        if ($this->isColumnModified(ResumenPeer::COLONIA_REFERENCIA_3)) {
            $modifiedColumns[':p' . $index++]  = '`colonia_referencia_3`';
        }
        if ($this->isColumnModified(ResumenPeer::CIUDAD_REFERENCIA_3)) {
            $modifiedColumns[':p' . $index++]  = '`ciudad_referencia_3`';
        }
        if ($this->isColumnModified(ResumenPeer::ESTADO_REFERENCIA_3)) {
            $modifiedColumns[':p' . $index++]  = '`estado_referencia_3`';
        }
        if ($this->isColumnModified(ResumenPeer::CP_REFERENCIA_3)) {
            $modifiedColumns[':p' . $index++]  = '`cp_referencia_3`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_1_REF_3)) {
            $modifiedColumns[':p' . $index++]  = '`tel_1_ref_3`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_2_REF_3)) {
            $modifiedColumns[':p' . $index++]  = '`tel_2_ref_3`';
        }
        if ($this->isColumnModified(ResumenPeer::PARENTESCO_REF_4)) {
            $modifiedColumns[':p' . $index++]  = '`parentesco_ref_4`';
        }
        if ($this->isColumnModified(ResumenPeer::NOMBRE_REFERENCIA_4)) {
            $modifiedColumns[':p' . $index++]  = '`nombre_referencia_4`';
        }
        if ($this->isColumnModified(ResumenPeer::DOMICILIO_DEUDOR_2)) {
            $modifiedColumns[':p' . $index++]  = '`domicilio_deudor_2`';
        }
        if ($this->isColumnModified(ResumenPeer::FRECUENCIA)) {
            $modifiedColumns[':p' . $index++]  = '`frecuencia`';
        }
        if ($this->isColumnModified(ResumenPeer::ORIGINACION)) {
            $modifiedColumns[':p' . $index++]  = '`originacion`';
        }
        if ($this->isColumnModified(ResumenPeer::SUCURSAL_CLIENTE)) {
            $modifiedColumns[':p' . $index++]  = '`sucursal_cliente`';
        }
        if ($this->isColumnModified(ResumenPeer::CP_REFERENCIA_4)) {
            $modifiedColumns[':p' . $index++]  = '`cp_referencia_4`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_1_REF_4)) {
            $modifiedColumns[':p' . $index++]  = '`tel_1_ref_4`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_2_REF_4)) {
            $modifiedColumns[':p' . $index++]  = '`tel_2_ref_4`';
        }
        if ($this->isColumnModified(ResumenPeer::DOMICILIO_LABORAL)) {
            $modifiedColumns[':p' . $index++]  = '`domicilio_laboral`';
        }
        if ($this->isColumnModified(ResumenPeer::COLONIA_LABORAL)) {
            $modifiedColumns[':p' . $index++]  = '`colonia_laboral`';
        }
        if ($this->isColumnModified(ResumenPeer::CIUDAD_LABORAL)) {
            $modifiedColumns[':p' . $index++]  = '`ciudad_laboral`';
        }
        if ($this->isColumnModified(ResumenPeer::ESTADO_LABORAL)) {
            $modifiedColumns[':p' . $index++]  = '`estado_laboral`';
        }
        if ($this->isColumnModified(ResumenPeer::CP_LABORAL)) {
            $modifiedColumns[':p' . $index++]  = '`cp_laboral`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_1_LABORAL)) {
            $modifiedColumns[':p' . $index++]  = '`tel_1_laboral`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_2_LABORAL)) {
            $modifiedColumns[':p' . $index++]  = '`tel_2_laboral`';
        }
        if ($this->isColumnModified(ResumenPeer::SALDO_CORRIENTE)) {
            $modifiedColumns[':p' . $index++]  = '`saldo_corriente`';
        }
        if ($this->isColumnModified(ResumenPeer::FECHA_DE_ACTUALIZACION)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_de_actualizacion`';
        }
        if ($this->isColumnModified(ResumenPeer::NUMERO_DE_CUENTA)) {
            $modifiedColumns[':p' . $index++]  = '`numero_de_cuenta`';
        }
        if ($this->isColumnModified(ResumenPeer::NUMERO_DE_CREDITO)) {
            $modifiedColumns[':p' . $index++]  = '`numero_de_credito`';
        }
        if ($this->isColumnModified(ResumenPeer::CONTRATO)) {
            $modifiedColumns[':p' . $index++]  = '`contrato`';
        }
        if ($this->isColumnModified(ResumenPeer::SALDO_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = '`saldo_total`';
        }
        if ($this->isColumnModified(ResumenPeer::SALDO_VENCIDO)) {
            $modifiedColumns[':p' . $index++]  = '`saldo_vencido`';
        }
        if ($this->isColumnModified(ResumenPeer::SALDO_DESCUENTO_1)) {
            $modifiedColumns[':p' . $index++]  = '`saldo_descuento_1`';
        }
        if ($this->isColumnModified(ResumenPeer::SALDO_DESCUENTO_2)) {
            $modifiedColumns[':p' . $index++]  = '`saldo_descuento_2`';
        }
        if ($this->isColumnModified(ResumenPeer::FECHA_CORTE)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_corte`';
        }
        if ($this->isColumnModified(ResumenPeer::FECHA_LIMITE)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_limite`';
        }
        if ($this->isColumnModified(ResumenPeer::FECHA_DE_ULTIMO_PAGO)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_de_ultimo_pago`';
        }
        if ($this->isColumnModified(ResumenPeer::MONTO_ULTIMO_PAGO)) {
            $modifiedColumns[':p' . $index++]  = '`monto_ultimo_pago`';
        }
        if ($this->isColumnModified(ResumenPeer::PRODUCTO)) {
            $modifiedColumns[':p' . $index++]  = '`producto`';
        }
        if ($this->isColumnModified(ResumenPeer::SUBPRODUCTO)) {
            $modifiedColumns[':p' . $index++]  = '`subproducto`';
        }
        if ($this->isColumnModified(ResumenPeer::CLIENTE)) {
            $modifiedColumns[':p' . $index++]  = '`cliente`';
        }
        if ($this->isColumnModified(ResumenPeer::STATUS_DE_CREDITO)) {
            $modifiedColumns[':p' . $index++]  = '`status_de_credito`';
        }
        if ($this->isColumnModified(ResumenPeer::PAGOS_VENCIDOS)) {
            $modifiedColumns[':p' . $index++]  = '`pagos_vencidos`';
        }
        if ($this->isColumnModified(ResumenPeer::MONTO_ADEUDADO)) {
            $modifiedColumns[':p' . $index++]  = '`monto_adeudado`';
        }
        if ($this->isColumnModified(ResumenPeer::FECHA_DE_ASIGNACION)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_de_asignacion`';
        }
        if ($this->isColumnModified(ResumenPeer::FECHA_DE_DEASIGNACION)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_de_deasignacion`';
        }
        if ($this->isColumnModified(ResumenPeer::CUENTA_CONCENTRADORA_1)) {
            $modifiedColumns[':p' . $index++]  = '`cuenta_concentradora_1`';
        }
        if ($this->isColumnModified(ResumenPeer::SALDO_CUOTA)) {
            $modifiedColumns[':p' . $index++]  = '`saldo_cuota`';
        }
        if ($this->isColumnModified(ResumenPeer::EMAIL_DEUDOR)) {
            $modifiedColumns[':p' . $index++]  = '`email_deudor`';
        }
        if ($this->isColumnModified(ResumenPeer::ID_CUENTA)) {
            $modifiedColumns[':p' . $index++]  = '`id_cuenta`';
        }
        if ($this->isColumnModified(ResumenPeer::NSS)) {
            $modifiedColumns[':p' . $index++]  = '`nss`';
        }
        if ($this->isColumnModified(ResumenPeer::RFC_DEUDOR)) {
            $modifiedColumns[':p' . $index++]  = '`rfc_deudor`';
        }
        if ($this->isColumnModified(ResumenPeer::TELEFONOS_MARCADOS)) {
            $modifiedColumns[':p' . $index++]  = '`telefonos_marcados`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_1_VERIF)) {
            $modifiedColumns[':p' . $index++]  = '`tel_1_verif`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_2_VERIF)) {
            $modifiedColumns[':p' . $index++]  = '`tel_2_verif`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_3_VERIF)) {
            $modifiedColumns[':p' . $index++]  = '`tel_3_verif`';
        }
        if ($this->isColumnModified(ResumenPeer::TEL_4_VERIF)) {
            $modifiedColumns[':p' . $index++]  = '`tel_4_verif`';
        }
        if ($this->isColumnModified(ResumenPeer::TELEFONO_DE_ULTIMO_CONTACTO)) {
            $modifiedColumns[':p' . $index++]  = '`telefono_de_ultimo_contacto`';
        }
        if ($this->isColumnModified(ResumenPeer::DIAS_VENCIDOS)) {
            $modifiedColumns[':p' . $index++]  = '`dias_vencidos`';
        }
        if ($this->isColumnModified(ResumenPeer::EJECUTIVO_ASIGNADO_CALL_CENTER)) {
            $modifiedColumns[':p' . $index++]  = '`ejecutivo_asignado_call_center`';
        }
        if ($this->isColumnModified(ResumenPeer::EJECUTIVO_ASIGNADO_DOMICILIARIO)) {
            $modifiedColumns[':p' . $index++]  = '`ejecutivo_asignado_domiciliario`';
        }
        if ($this->isColumnModified(ResumenPeer::PRIORIDAD_DE_GESTION)) {
            $modifiedColumns[':p' . $index++]  = '`prioridad_de_gestion`';
        }
        if ($this->isColumnModified(ResumenPeer::NRPP)) {
            $modifiedColumns[':p' . $index++]  = '`nrpp`';
        }
        if ($this->isColumnModified(ResumenPeer::PARENTESCO_AVAL)) {
            $modifiedColumns[':p' . $index++]  = '`parentesco_aval`';
        }
        if ($this->isColumnModified(ResumenPeer::LOCALIZAR)) {
            $modifiedColumns[':p' . $index++]  = '`localizar`';
        }
        if ($this->isColumnModified(ResumenPeer::FECHA_ULTIMA_GESTION)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_ultima_gestion`';
        }
        if ($this->isColumnModified(ResumenPeer::EMPRESA)) {
            $modifiedColumns[':p' . $index++]  = '`empresa`';
        }
        if ($this->isColumnModified(ResumenPeer::TIMELOCK)) {
            $modifiedColumns[':p' . $index++]  = '`timelock`';
        }
        if ($this->isColumnModified(ResumenPeer::LOCKER)) {
            $modifiedColumns[':p' . $index++]  = '`locker`';
        }
        if ($this->isColumnModified(ResumenPeer::FECHA_CONVENIO)) {
            $modifiedColumns[':p' . $index++]  = '`fecha_convenio`';
        }
        if ($this->isColumnModified(ResumenPeer::ESPECIAL)) {
            $modifiedColumns[':p' . $index++]  = '`especial`';
        }
        if ($this->isColumnModified(ResumenPeer::DIRECCION_NUEVA)) {
            $modifiedColumns[':p' . $index++]  = '`direccion_nueva`';
        }
        if ($this->isColumnModified(ResumenPeer::NOROBOT)) {
            $modifiedColumns[':p' . $index++]  = '`norobot`';
        }

        $sql = sprintf(
            'INSERT INTO `resumen` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`status_aarsa`':
                        ...
                        break;
                    case '`avapar`':
                        $stmt->bindValue($identifier, $this->avapar, PDO::PARAM_STR);
                        break;
                    ...
                    case '`nombre_referencia_4`':
                        ...
                        break;
                    case '`domicilio_deudor_2`':
                        $stmt->bindValue($identifier, $this->domicilio_deudor_2, PDO::PARAM_STR);
                        break;
                    case '`frecuencia`':
                        $stmt->bindValue($identifier, $this->frecuencia, PDO::PARAM_STR);
                        break;
                    case '`originacion`':
                        $stmt->bindValue($identifier, $this->originacion, PDO::PARAM_STR);
                        break;
                    ...
                    case '`prioridad_de_gestion`':
                        ...
                        break;
                    case '`nrpp`':
                        $stmt->bindValue($identifier, $this->nrpp, PDO::PARAM_STR);
                        break;
                    ...
                    case '`locker`':
                        ...
                        break;
                    case '`fecha_convenio`':
                        $stmt->bindValue($identifier, $this->fecha_convenio, PDO::PARAM_STR);
                        break;
                    case '`especial`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ResumenPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ResumenPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 54:
                ...
                break;
            case 55:
                return $this->getDomicilioDeudor2();
                break;
            case 56:
                return $this->getFrecuencia();
                break;
            case 57:
                return $this->getOriginacion();
                break;
            case 58:
    ...
    {
        if (isset($alreadyDumpedObjects['Resumen'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Resumen'][$this->getPrimaryKey()] = true;
        $keys = ResumenPeer::getFieldNames($keyType);
        $result = array(
            ...
            $keys[55] => $this->getDomicilioDeudor2(),
            $keys[56] => $this->getFrecuencia(),
            $keys[57] => $this->getOriginacion(),
            $keys[58] => $this->getSucursalCliente(),
            ...
            $keys[113] => $this->getFechaConvenio(),
    ...
    public function setByPosition($pos, $value)
    {
        switch ($pos) {
            ...
            case 54:
                ...
                break;
            case 55:
                $this->setDomicilioDeudor2($value);
                break;
            case 56:
                $this->setFrecuencia($value);
                break;
            case 57:
                $this->setOriginacion($value);
                break;
            case 58:
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[25], $arr)) $this->setAvapar($arr[$keys[25]]);
        ...
        if (array_key_exists($keys[55], $arr)) $this->setDomicilioDeudor2($arr[$keys[55]]);
        if (array_key_exists($keys[56], $arr)) $this->setFrecuencia($arr[$keys[56]]);
        if (array_key_exists($keys[57], $arr)) $this->setOriginacion($arr[$keys[57]]);
        if (array_key_exists($keys[58], $arr)) $this->setSucursalCliente($arr[$keys[58]]);
        ...
        if (array_key_exists($keys[94], $arr)) $this->setNss($arr[$keys[94]]);
        ...
        if (array_key_exists($keys[106], $arr)) $this->setNrpp($arr[$keys[106]]);
        ...
        if (array_key_exists($keys[113], $arr)) $this->setFechaConvenio($arr[$keys[113]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ResumenPeer::NOMBRE_DEUDOR)) $criteria->add(ResumenPeer::NOMBRE_DEUDOR, $this->nombre_deudor);
        if ($this->isColumnModified(ResumenPeer::DOMICILIO_DEUDOR)) $criteria->add(ResumenPeer::DOMICILIO_DEUDOR, $this->domicilio_deudor);
        if ($this->isColumnModified(ResumenPeer::COLONIA_DEUDOR)) $criteria->add(ResumenPeer::COLONIA_DEUDOR, $this->colonia_deudor);
        if ($this->isColumnModified(ResumenPeer::CIUDAD_DEUDOR)) $criteria->add(ResumenPeer::CIUDAD_DEUDOR, $this->ciudad_deudor);
        if ($this->isColumnModified(ResumenPeer::ESTADO_DEUDOR)) $criteria->add(ResumenPeer::ESTADO_DEUDOR, $this->estado_deudor);
        if ($this->isColumnModified(ResumenPeer::CP_DEUDOR)) $criteria->add(ResumenPeer::CP_DEUDOR, $this->cp_deudor);
        if ($this->isColumnModified(ResumenPeer::PLANO_GUIA_ROJI)) $criteria->add(ResumenPeer::PLANO_GUIA_ROJI, $this->plano_guia_roji);
        if ($this->isColumnModified(ResumenPeer::CUADRANTE_GUIA_ROJI)) $criteria->add(ResumenPeer::CUADRANTE_GUIA_ROJI, $this->cuadrante_guia_roji);
        if ($this->isColumnModified(ResumenPeer::TEL_1)) $criteria->add(ResumenPeer::TEL_1, $this->tel_1);
        if ($this->isColumnModified(ResumenPeer::TEL_2)) $criteria->add(ResumenPeer::TEL_2, $this->tel_2);
        if ($this->isColumnModified(ResumenPeer::TEL_3)) $criteria->add(ResumenPeer::TEL_3, $this->tel_3);
        if ($this->isColumnModified(ResumenPeer::TEL_4)) $criteria->add(ResumenPeer::TEL_4, $this->tel_4);
        if ($this->isColumnModified(ResumenPeer::NOMBRE_DEUDOR_ALTERNO)) $criteria->add(ResumenPeer::NOMBRE_DEUDOR_ALTERNO, $this->nombre_deudor_alterno);
        if ($this->isColumnModified(ResumenPeer::DOMICILIO_DEUDOR_ALTERNO)) $criteria->add(ResumenPeer::DOMICILIO_DEUDOR_ALTERNO, $this->domicilio_deudor_alterno);
        if ($this->isColumnModified(ResumenPeer::COLONIA_DEUDOR_ALTERNO)) $criteria->add(ResumenPeer::COLONIA_DEUDOR_ALTERNO, $this->colonia_deudor_alterno);
        if ($this->isColumnModified(ResumenPeer::CIUDAD_DEUDOR_ALTERNO)) $criteria->add(ResumenPeer::CIUDAD_DEUDOR_ALTERNO, $this->ciudad_deudor_alterno);
        if ($this->isColumnModified(ResumenPeer::ESTADO_DEUDOR_ALTERNO)) $criteria->add(ResumenPeer::ESTADO_DEUDOR_ALTERNO, $this->estado_deudor_alterno);
        if ($this->isColumnModified(ResumenPeer::CP_DEUDOR_ATERNO)) $criteria->add(ResumenPeer::CP_DEUDOR_ATERNO, $this->cp_deudor_aterno);
        if ($this->isColumnModified(ResumenPeer::TEL_1_ALTERNO)) $criteria->add(ResumenPeer::TEL_1_ALTERNO, $this->tel_1_alterno);
        if ($this->isColumnModified(ResumenPeer::TEL_2_ALTERNO)) $criteria->add(ResumenPeer::TEL_2_ALTERNO, $this->tel_2_alterno);
        if ($this->isColumnModified(ResumenPeer::TEL_3_ALTERNO)) $criteria->add(ResumenPeer::TEL_3_ALTERNO, $this->tel_3_alterno);
        if ($this->isColumnModified(ResumenPeer::TEL_4_ALTERNO)) $criteria->add(ResumenPeer::TEL_4_ALTERNO, $this->tel_4_alterno);
        if ($this->isColumnModified(ResumenPeer::PLANO_GUIA_ROJI_ALTERNO)) $criteria->add(ResumenPeer::PLANO_GUIA_ROJI_ALTERNO, $this->plano_guia_roji_alterno);
        if ($this->isColumnModified(ResumenPeer::CUADRANTE_GUIA_ROJI_ALTERNO)) $criteria->add(ResumenPeer::CUADRANTE_GUIA_ROJI_ALTERNO, $this->cuadrante_guia_roji_alterno);
        if ($this->isColumnModified(ResumenPeer::STATUS_AARSA)) $criteria->add(ResumenPeer::STATUS_AARSA, $this->status_aarsa);
        if ($this->isColumnModified(ResumenPeer::AVAPAR)) $criteria->add(ResumenPeer::AVAPAR, $this->avapar);
        if ($this->isColumnModified(ResumenPeer::PARENTESCO_REF_1)) $criteria->add(ResumenPeer::PARENTESCO_REF_1, $this->parentesco_ref_1);
        if ($this->isColumnModified(ResumenPeer::NOMBRE_REFERENCIA_1)) $criteria->add(ResumenPeer::NOMBRE_REFERENCIA_1, $this->nombre_referencia_1);
        if ($this->isColumnModified(ResumenPeer::DOMICILIO_REFERENCIA_1)) $criteria->add(ResumenPeer::DOMICILIO_REFERENCIA_1, $this->domicilio_referencia_1);
        if ($this->isColumnModified(ResumenPeer::COLONIA_REFERENCIA_1)) $criteria->add(ResumenPeer::COLONIA_REFERENCIA_1, $this->colonia_referencia_1);
        if ($this->isColumnModified(ResumenPeer::CIUDAD_REFERENCIA_1)) $criteria->add(ResumenPeer::CIUDAD_REFERENCIA_1, $this->ciudad_referencia_1);
        if ($this->isColumnModified(ResumenPeer::ESTADO_REFERENCIA_1)) $criteria->add(ResumenPeer::ESTADO_REFERENCIA_1, $this->estado_referencia_1);
        if ($this->isColumnModified(ResumenPeer::CP_REFERENCIA_1)) $criteria->add(ResumenPeer::CP_REFERENCIA_1, $this->cp_referencia_1);
        if ($this->isColumnModified(ResumenPeer::TEL_1_REF_1)) $criteria->add(ResumenPeer::TEL_1_REF_1, $this->tel_1_ref_1);
        if ($this->isColumnModified(ResumenPeer::TEL_2_REF_1)) $criteria->add(ResumenPeer::TEL_2_REF_1, $this->tel_2_ref_1);
        if ($this->isColumnModified(ResumenPeer::PARENTESCO_REF_2)) $criteria->add(ResumenPeer::PARENTESCO_REF_2, $this->parentesco_ref_2);
        if ($this->isColumnModified(ResumenPeer::NOMBRE_REFERENCIA_2)) $criteria->add(ResumenPeer::NOMBRE_REFERENCIA_2, $this->nombre_referencia_2);
        if ($this->isColumnModified(ResumenPeer::DOMICILIO_REFERENCIA_2)) $criteria->add(ResumenPeer::DOMICILIO_REFERENCIA_2, $this->domicilio_referencia_2);
        if ($this->isColumnModified(ResumenPeer::COLONIA_REFERENCIA_2)) $criteria->add(ResumenPeer::COLONIA_REFERENCIA_2, $this->colonia_referencia_2);
        if ($this->isColumnModified(ResumenPeer::CIUDAD_REFERENCIA_2)) $criteria->add(ResumenPeer::CIUDAD_REFERENCIA_2, $this->ciudad_referencia_2);
        if ($this->isColumnModified(ResumenPeer::ESTADO_REFERENCIA_2)) $criteria->add(ResumenPeer::ESTADO_REFERENCIA_2, $this->estado_referencia_2);
        if ($this->isColumnModified(ResumenPeer::CP_REFERENCIA_2)) $criteria->add(ResumenPeer::CP_REFERENCIA_2, $this->cp_referencia_2);
        if ($this->isColumnModified(ResumenPeer::TEL_1_REF_2)) $criteria->add(ResumenPeer::TEL_1_REF_2, $this->tel_1_ref_2);
        if ($this->isColumnModified(ResumenPeer::TEL_2_REF_2)) $criteria->add(ResumenPeer::TEL_2_REF_2, $this->tel_2_ref_2);
        if ($this->isColumnModified(ResumenPeer::PARENTESCO_REF_3)) $criteria->add(ResumenPeer::PARENTESCO_REF_3, $this->parentesco_ref_3);
        if ($this->isColumnModified(ResumenPeer::NOMBRE_REFERENCIA_3)) $criteria->add(ResumenPeer::NOMBRE_REFERENCIA_3, $this->nombre_referencia_3);
        if ($this->isColumnModified(ResumenPeer::DOMICILIO_REFERENCIA_3)) $criteria->add(ResumenPeer::DOMICILIO_REFERENCIA_3, $this->domicilio_referencia_3);
        if ($this->isColumnModified(ResumenPeer::COLONIA_REFERENCIA_3)) $criteria->add(ResumenPeer::COLONIA_REFERENCIA_3, $this->colonia_referencia_3);
        if ($this->isColumnModified(ResumenPeer::CIUDAD_REFERENCIA_3)) $criteria->add(ResumenPeer::CIUDAD_REFERENCIA_3, $this->ciudad_referencia_3);
        if ($this->isColumnModified(ResumenPeer::ESTADO_REFERENCIA_3)) $criteria->add(ResumenPeer::ESTADO_REFERENCIA_3, $this->estado_referencia_3);
        if ($this->isColumnModified(ResumenPeer::CP_REFERENCIA_3)) $criteria->add(ResumenPeer::CP_REFERENCIA_3, $this->cp_referencia_3);
        if ($this->isColumnModified(ResumenPeer::TEL_1_REF_3)) $criteria->add(ResumenPeer::TEL_1_REF_3, $this->tel_1_ref_3);
        if ($this->isColumnModified(ResumenPeer::TEL_2_REF_3)) $criteria->add(ResumenPeer::TEL_2_REF_3, $this->tel_2_ref_3);
        if ($this->isColumnModified(ResumenPeer::PARENTESCO_REF_4)) $criteria->add(ResumenPeer::PARENTESCO_REF_4, $this->parentesco_ref_4);
        if ($this->isColumnModified(ResumenPeer::NOMBRE_REFERENCIA_4)) $criteria->add(ResumenPeer::NOMBRE_REFERENCIA_4, $this->nombre_referencia_4);
        if ($this->isColumnModified(ResumenPeer::DOMICILIO_DEUDOR_2)) $criteria->add(ResumenPeer::DOMICILIO_DEUDOR_2, $this->domicilio_deudor_2);
        if ($this->isColumnModified(ResumenPeer::FRECUENCIA)) $criteria->add(ResumenPeer::FRECUENCIA, $this->frecuencia);
        if ($this->isColumnModified(ResumenPeer::ORIGINACION)) $criteria->add(ResumenPeer::ORIGINACION, $this->originacion);
        if ($this->isColumnModified(ResumenPeer::SUCURSAL_CLIENTE)) $criteria->add(ResumenPeer::SUCURSAL_CLIENTE, $this->sucursal_cliente);
        if ($this->isColumnModified(ResumenPeer::CP_REFERENCIA_4)) $criteria->add(ResumenPeer::CP_REFERENCIA_4, $this->cp_referencia_4);
        if ($this->isColumnModified(ResumenPeer::TEL_1_REF_4)) $criteria->add(ResumenPeer::TEL_1_REF_4, $this->tel_1_ref_4);
        if ($this->isColumnModified(ResumenPeer::TEL_2_REF_4)) $criteria->add(ResumenPeer::TEL_2_REF_4, $this->tel_2_ref_4);
        if ($this->isColumnModified(ResumenPeer::DOMICILIO_LABORAL)) $criteria->add(ResumenPeer::DOMICILIO_LABORAL, $this->domicilio_laboral);
        if ($this->isColumnModified(ResumenPeer::COLONIA_LABORAL)) $criteria->add(ResumenPeer::COLONIA_LABORAL, $this->colonia_laboral);
        if ($this->isColumnModified(ResumenPeer::CIUDAD_LABORAL)) $criteria->add(ResumenPeer::CIUDAD_LABORAL, $this->ciudad_laboral);
        if ($this->isColumnModified(ResumenPeer::ESTADO_LABORAL)) $criteria->add(ResumenPeer::ESTADO_LABORAL, $this->estado_laboral);
        if ($this->isColumnModified(ResumenPeer::CP_LABORAL)) $criteria->add(ResumenPeer::CP_LABORAL, $this->cp_laboral);
        if ($this->isColumnModified(ResumenPeer::TEL_1_LABORAL)) $criteria->add(ResumenPeer::TEL_1_LABORAL, $this->tel_1_laboral);
        if ($this->isColumnModified(ResumenPeer::TEL_2_LABORAL)) $criteria->add(ResumenPeer::TEL_2_LABORAL, $this->tel_2_laboral);
        if ($this->isColumnModified(ResumenPeer::SALDO_CORRIENTE)) $criteria->add(ResumenPeer::SALDO_CORRIENTE, $this->saldo_corriente);
        if ($this->isColumnModified(ResumenPeer::FECHA_DE_ACTUALIZACION)) $criteria->add(ResumenPeer::FECHA_DE_ACTUALIZACION, $this->fecha_de_actualizacion);
        if ($this->isColumnModified(ResumenPeer::NUMERO_DE_CUENTA)) $criteria->add(ResumenPeer::NUMERO_DE_CUENTA, $this->numero_de_cuenta);
        if ($this->isColumnModified(ResumenPeer::NUMERO_DE_CREDITO)) $criteria->add(ResumenPeer::NUMERO_DE_CREDITO, $this->numero_de_credito);
        if ($this->isColumnModified(ResumenPeer::CONTRATO)) $criteria->add(ResumenPeer::CONTRATO, $this->contrato);
        if ($this->isColumnModified(ResumenPeer::SALDO_TOTAL)) $criteria->add(ResumenPeer::SALDO_TOTAL, $this->saldo_total);
        if ($this->isColumnModified(ResumenPeer::SALDO_VENCIDO)) $criteria->add(ResumenPeer::SALDO_VENCIDO, $this->saldo_vencido);
        if ($this->isColumnModified(ResumenPeer::SALDO_DESCUENTO_1)) $criteria->add(ResumenPeer::SALDO_DESCUENTO_1, $this->saldo_descuento_1);
        if ($this->isColumnModified(ResumenPeer::SALDO_DESCUENTO_2)) $criteria->add(ResumenPeer::SALDO_DESCUENTO_2, $this->saldo_descuento_2);
        if ($this->isColumnModified(ResumenPeer::FECHA_CORTE)) $criteria->add(ResumenPeer::FECHA_CORTE, $this->fecha_corte);
        if ($this->isColumnModified(ResumenPeer::FECHA_LIMITE)) $criteria->add(ResumenPeer::FECHA_LIMITE, $this->fecha_limite);
        if ($this->isColumnModified(ResumenPeer::FECHA_DE_ULTIMO_PAGO)) $criteria->add(ResumenPeer::FECHA_DE_ULTIMO_PAGO, $this->fecha_de_ultimo_pago);
        if ($this->isColumnModified(ResumenPeer::MONTO_ULTIMO_PAGO)) $criteria->add(ResumenPeer::MONTO_ULTIMO_PAGO, $this->monto_ultimo_pago);
        if ($this->isColumnModified(ResumenPeer::PRODUCTO)) $criteria->add(ResumenPeer::PRODUCTO, $this->producto);
        if ($this->isColumnModified(ResumenPeer::SUBPRODUCTO)) $criteria->add(ResumenPeer::SUBPRODUCTO, $this->subproducto);
        if ($this->isColumnModified(ResumenPeer::CLIENTE)) $criteria->add(ResumenPeer::CLIENTE, $this->cliente);
        if ($this->isColumnModified(ResumenPeer::STATUS_DE_CREDITO)) $criteria->add(ResumenPeer::STATUS_DE_CREDITO, $this->status_de_credito);
        if ($this->isColumnModified(ResumenPeer::PAGOS_VENCIDOS)) $criteria->add(ResumenPeer::PAGOS_VENCIDOS, $this->pagos_vencidos);
        if ($this->isColumnModified(ResumenPeer::MONTO_ADEUDADO)) $criteria->add(ResumenPeer::MONTO_ADEUDADO, $this->monto_adeudado);
        if ($this->isColumnModified(ResumenPeer::FECHA_DE_ASIGNACION)) $criteria->add(ResumenPeer::FECHA_DE_ASIGNACION, $this->fecha_de_asignacion);
        if ($this->isColumnModified(ResumenPeer::FECHA_DE_DEASIGNACION)) $criteria->add(ResumenPeer::FECHA_DE_DEASIGNACION, $this->fecha_de_deasignacion);
        if ($this->isColumnModified(ResumenPeer::CUENTA_CONCENTRADORA_1)) $criteria->add(ResumenPeer::CUENTA_CONCENTRADORA_1, $this->cuenta_concentradora_1);
        if ($this->isColumnModified(ResumenPeer::SALDO_CUOTA)) $criteria->add(ResumenPeer::SALDO_CUOTA, $this->saldo_cuota);
        if ($this->isColumnModified(ResumenPeer::EMAIL_DEUDOR)) $criteria->add(ResumenPeer::EMAIL_DEUDOR, $this->email_deudor);
        if ($this->isColumnModified(ResumenPeer::ID_CUENTA)) $criteria->add(ResumenPeer::ID_CUENTA, $this->id_cuenta);
        if ($this->isColumnModified(ResumenPeer::NSS)) $criteria->add(ResumenPeer::NSS, $this->nss);
        if ($this->isColumnModified(ResumenPeer::RFC_DEUDOR)) $criteria->add(ResumenPeer::RFC_DEUDOR, $this->rfc_deudor);
        if ($this->isColumnModified(ResumenPeer::TELEFONOS_MARCADOS)) $criteria->add(ResumenPeer::TELEFONOS_MARCADOS, $this->telefonos_marcados);
        if ($this->isColumnModified(ResumenPeer::TEL_1_VERIF)) $criteria->add(ResumenPeer::TEL_1_VERIF, $this->tel_1_verif);
        if ($this->isColumnModified(ResumenPeer::TEL_2_VERIF)) $criteria->add(ResumenPeer::TEL_2_VERIF, $this->tel_2_verif);
        if ($this->isColumnModified(ResumenPeer::TEL_3_VERIF)) $criteria->add(ResumenPeer::TEL_3_VERIF, $this->tel_3_verif);
        if ($this->isColumnModified(ResumenPeer::TEL_4_VERIF)) $criteria->add(ResumenPeer::TEL_4_VERIF, $this->tel_4_verif);
        if ($this->isColumnModified(ResumenPeer::TELEFONO_DE_ULTIMO_CONTACTO)) $criteria->add(ResumenPeer::TELEFONO_DE_ULTIMO_CONTACTO, $this->telefono_de_ultimo_contacto);
        if ($this->isColumnModified(ResumenPeer::DIAS_VENCIDOS)) $criteria->add(ResumenPeer::DIAS_VENCIDOS, $this->dias_vencidos);
        if ($this->isColumnModified(ResumenPeer::EJECUTIVO_ASIGNADO_CALL_CENTER)) $criteria->add(ResumenPeer::EJECUTIVO_ASIGNADO_CALL_CENTER, $this->ejecutivo_asignado_call_center);
        if ($this->isColumnModified(ResumenPeer::EJECUTIVO_ASIGNADO_DOMICILIARIO)) $criteria->add(ResumenPeer::EJECUTIVO_ASIGNADO_DOMICILIARIO, $this->ejecutivo_asignado_domiciliario);
        if ($this->isColumnModified(ResumenPeer::PRIORIDAD_DE_GESTION)) $criteria->add(ResumenPeer::PRIORIDAD_DE_GESTION, $this->prioridad_de_gestion);
        if ($this->isColumnModified(ResumenPeer::NRPP)) $criteria->add(ResumenPeer::NRPP, $this->nrpp);
        if ($this->isColumnModified(ResumenPeer::PARENTESCO_AVAL)) $criteria->add(ResumenPeer::PARENTESCO_AVAL, $this->parentesco_aval);
        if ($this->isColumnModified(ResumenPeer::LOCALIZAR)) $criteria->add(ResumenPeer::LOCALIZAR, $this->localizar);
        if ($this->isColumnModified(ResumenPeer::FECHA_ULTIMA_GESTION)) $criteria->add(ResumenPeer::FECHA_ULTIMA_GESTION, $this->fecha_ultima_gestion);
        if ($this->isColumnModified(ResumenPeer::EMPRESA)) $criteria->add(ResumenPeer::EMPRESA, $this->empresa);
        if ($this->isColumnModified(ResumenPeer::TIMELOCK)) $criteria->add(ResumenPeer::TIMELOCK, $this->timelock);
        if ($this->isColumnModified(ResumenPeer::LOCKER)) $criteria->add(ResumenPeer::LOCKER, $this->locker);
        if ($this->isColumnModified(ResumenPeer::FECHA_CONVENIO)) $criteria->add(ResumenPeer::FECHA_CONVENIO, $this->fecha_convenio);
        if ($this->isColumnModified(ResumenPeer::ESPECIAL)) $criteria->add(ResumenPeer::ESPECIAL, $this->especial);
        if ($this->isColumnModified(ResumenPeer::DIRECCION_NUEVA)) $criteria->add(ResumenPeer::DIRECCION_NUEVA, $this->direccion_nueva);
        if ($this->isColumnModified(ResumenPeer::NOROBOT)) $criteria->add(ResumenPeer::NOROBOT, $this->norobot);
    ...
    {
        $criteria = new Criteria(ResumenPeer::DATABASE_NAME);
        $criteria->add(ResumenPeer::ID_CUENTA, $this->id_cuenta);
     ...
     * objects.
     *
     * @param object $copyObj An object of Resumen (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setAvapar($this->getAvapar());
        ...
        $copyObj->setDomicilioDeudor2($this->getDomicilioDeudor2());
        $copyObj->setFrecuencia($this->getFrecuencia());
        $copyObj->setOriginacion($this->getOriginacion());
        ...
        $copyObj->setFechaConvenio($this->getFechaConvenio());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Resumen Clone of current object.
     * @throws PropelException
     */
    ...
    public function clear()
    {
        ...
        $this->domicilio_deudor_2 = null;
        $this->frecuencia = null;
        $this->originacion = null;
    ...
    {
        return (string) $this->exportTo(ResumenPeer::DEFAULT_STRING_FORMAT);
    }
