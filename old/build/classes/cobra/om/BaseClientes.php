...
abstract class BaseClientes extends BaseObject implements Persistent
{
    ...
    public function setCliente($v)
    {
        ...
        if ($this->cliente !== $v) {
            $this->cliente = $v;
            $this->modifiedColumns[] = ClientesPeer::CLIENTE;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 1; // 1 = ClientesPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ClientesPeer::CLIENTE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClientesPeer::CLIENTE)) $criteria->add(ClientesPeer::CLIENTE, $this->cliente);
    ...
    {
        $criteria = new Criteria(ClientesPeer::DATABASE_NAME);
        $criteria->add(ClientesPeer::CLIENTE, $this->cliente);
    ...
    /**
     * Generic method to set the primary key (cliente column).
     *
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        if ($makeNew) {
            $copyObj->setNew(true);
            $copyObj->setCliente(NULL); // this is a auto-increment column, so set to default value
        }
    }
