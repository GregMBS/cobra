...
/**
 * Base class that represents a row from the 'permalog' table.
 *
 *
 *
 * @package    propel.generator.cobra.om
 */
abstract class BasePermalog extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'PermalogPeer';
     ...
     * @return Permalog The current object (for fluent API support)
     */
    public function setAuto($v)
    {
        ...
        if ($this->auto !== $v) {
            $this->auto = $v;
            $this->modifiedColumns[] = PermalogPeer::AUTO;
        }
    ...
    public function setUsuario($v)
    {
        ...
        if ($this->usuario !== $v) {
            $this->usuario = $v;
            $this->modifiedColumns[] = PermalogPeer::USUARIO;
        }
    ...
    public function setTipo($v)
    {
        ...
        if ($this->tipo !== $v) {
            $this->tipo = $v;
            $this->modifiedColumns[] = PermalogPeer::TIPO;
        }
    ...
    public function setFechahora($v)
    {
        ...
        if ($this->fechahora !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = PermalogPeer::FECHAHORA;
            }
    ...
    public function setGestor($v)
    {
        ...
        if ($this->gestor !== $v) {
            $this->gestor = $v;
            $this->modifiedColumns[] = PermalogPeer::GESTOR;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->fechahora = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->gestor = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = PermalogPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Permalog object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = PermalogPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = PermalogQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PermalogPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(PermalogPeer::AUTO)) {
            $modifiedColumns[':p' . $index++]  = '`auto`';
        }
        if ($this->isColumnModified(PermalogPeer::USUARIO)) {
            $modifiedColumns[':p' . $index++]  = '`usuario`';
        }
        if ($this->isColumnModified(PermalogPeer::TIPO)) {
            $modifiedColumns[':p' . $index++]  = '`tipo`';
        }
        if ($this->isColumnModified(PermalogPeer::FECHAHORA)) {
            $modifiedColumns[':p' . $index++]  = '`fechahora`';
        }
        if ($this->isColumnModified(PermalogPeer::GESTOR)) {
            $modifiedColumns[':p' . $index++]  = '`gestor`';
        }

        $sql = sprintf(
            'INSERT INTO `permalog` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = PermalogPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = PermalogPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Permalog'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Permalog'][$this->getPrimaryKey()] = true;
        $keys = PermalogPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getAuto(),
            $keys[1] => $this->getUsuario(),
            $keys[2] => $this->getTipo(),
            $keys[3] => $this->getFechahora(),
            $keys[4] => $this->getGestor(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setGestor($arr[$keys[4]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PermalogPeer::AUTO)) $criteria->add(PermalogPeer::AUTO, $this->auto);
        if ($this->isColumnModified(PermalogPeer::USUARIO)) $criteria->add(PermalogPeer::USUARIO, $this->usuario);
        if ($this->isColumnModified(PermalogPeer::TIPO)) $criteria->add(PermalogPeer::TIPO, $this->tipo);
        if ($this->isColumnModified(PermalogPeer::FECHAHORA)) $criteria->add(PermalogPeer::FECHAHORA, $this->fechahora);
        if ($this->isColumnModified(PermalogPeer::GESTOR)) $criteria->add(PermalogPeer::GESTOR, $this->gestor);
    ...
    {
        $criteria = new Criteria(PermalogPeer::DATABASE_NAME);
        $criteria->add(PermalogPeer::AUTO, $this->auto);
     ...
     * objects.
     *
     * @param object $copyObj An object of Permalog (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Permalog Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PermalogPeer::DEFAULT_STRING_FORMAT);
    }
