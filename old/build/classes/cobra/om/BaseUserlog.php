...
abstract class BaseUserlog extends BaseObject implements Persistent
{
    ...
    public function setAuto($v)
    {
        ...
        if ($this->auto !== $v) {
            $this->auto = $v;
            $this->modifiedColumns[] = UserlogPeer::AUTO;
        }
    ...
    public function setUsuario($v)
    {
        ...
        if ($this->usuario !== $v) {
            $this->usuario = $v;
            $this->modifiedColumns[] = UserlogPeer::USUARIO;
        }
    ...
    public function setTipo($v)
    {
        ...
        if ($this->tipo !== $v) {
            $this->tipo = $v;
            $this->modifiedColumns[] = UserlogPeer::TIPO;
        }
    ...
    public function setFechahora($v)
    {
        ...
        if ($this->fechahora !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = UserlogPeer::FECHAHORA;
            }
    ...
    public function setGestor($v)
    {
        ...
        if ($this->gestor !== $v) {
            $this->gestor = $v;
            $this->modifiedColumns[] = UserlogPeer::GESTOR;
        }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(UserlogPeer::AUTO)) {
            $modifiedColumns[':p' . $index++]  = '`auto`';
        }
        if ($this->isColumnModified(UserlogPeer::USUARIO)) {
            $modifiedColumns[':p' . $index++]  = '`usuario`';
        }
        if ($this->isColumnModified(UserlogPeer::TIPO)) {
            $modifiedColumns[':p' . $index++]  = '`tipo`';
        }
        if ($this->isColumnModified(UserlogPeer::FECHAHORA)) {
            $modifiedColumns[':p' . $index++]  = '`fechahora`';
        }
        if ($this->isColumnModified(UserlogPeer::GESTOR)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UserlogPeer::AUTO)) $criteria->add(UserlogPeer::AUTO, $this->auto);
        if ($this->isColumnModified(UserlogPeer::USUARIO)) $criteria->add(UserlogPeer::USUARIO, $this->usuario);
        if ($this->isColumnModified(UserlogPeer::TIPO)) $criteria->add(UserlogPeer::TIPO, $this->tipo);
        if ($this->isColumnModified(UserlogPeer::FECHAHORA)) $criteria->add(UserlogPeer::FECHAHORA, $this->fechahora);
        if ($this->isColumnModified(UserlogPeer::GESTOR)) $criteria->add(UserlogPeer::GESTOR, $this->gestor);
    ...
    {
        $criteria = new Criteria(UserlogPeer::DATABASE_NAME);
        $criteria->add(UserlogPeer::AUTO, $this->auto);
