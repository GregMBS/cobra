...
/**
 * This class defines the structure of the 'cyberres' table.
 *
 *
 *
 ...
 */
class CyberresTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'cobra.map.CyberresTableMap';
    ...
    {
        // attributes
        $this->setName('cyberres');
        $this->setPhpName('Cyberres');
        $this->setClassname('Cyberres');
