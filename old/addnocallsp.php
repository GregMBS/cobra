...
$querygable="SELECT id_cuenta, numero_de_cuenta,tel_1,'beatriz',cliente
from resumen 
where (cliente='Credito Si')
and fecha_de_actualizacion>'2011-03-01'
and not exists (select * from historia 
where resumen.id_cuenta=historia.c_cont and d_fech>='2011-03-01')
;";
...
$D_FECHa=array("2011-03-13","2011-03-13");
