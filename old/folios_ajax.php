...
$sQuery="CREATE TEMPORARY TABLE  `foliostab` (
  `auto` int(11) NOT NULL AUTO_INCREMENT,
  `folio` int(11),
  `cliente` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `enlace` varchar(255) COLLATE utf8_spanish_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`auto`)
)";
mysql_query( $sQuery, $con ) or die(mysql_error());
$sQuery="insert into foliostab (folio,cliente) 
SELECT folio,folios.cliente 
FROM folios 
where usado=0 
and cliente = '".$cliente."' 
order by folio;";
//die($sQuery);
mysql_query( $sQuery, $con ) or die(mysql_error());
$aColumns=array('folio','cliente','enlace');
$sTable='foliostab';
$sIndexColumn='auto';
	/* 
	 * Paging
...
//	die ($sQuery);
	 ...
	 */
	$output = array(
		"sEcho" => filter_input(INPUT_GET, 'sEcho', FILTER_VALIDATE_INT),
