...
and (day(d_fech)>14 or (day(d_fech)=14 and c_hrin>'14:35'))
and c_cvba='Credito Si' and c_cvge<>'Milt'
...
$filename="Layout_carga_de_gestiones_20_julio.xls";
...
$COBRADOR='';
if ($answer[3]=='270s') {$COBRADOR='1817';}
if ($answer[3]=='360s') {$COBRADOR='1818';}
if ($answer[3]=='720s') {$COBRADOR='1813';}
