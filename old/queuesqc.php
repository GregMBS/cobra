...
$oldgestor='';
$querylist = "SELECT queuelist.*,tipo FROM queuelist force index (sortby)
left join nombres on gestor=usuaria ORDER BY gestor,queuelist.camp";
...
$ECOUNT=$answer[4];
$EMOUNT=$answer[5];
$PCOUNT=round($ECOUNT/($COUNT+0.001)*100);
