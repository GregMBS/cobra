...
where n_prom>0 and greatest(d_prom1,d_prom2)>last_day(curdate()-interval 2 month)-interval 2 day  
and pagos.fecha>last_day(curdate()-interval 2 month)".$adjust."
...
where h1.c_cont=id_cuenta and fecha>last_day(curdate()-interval 2 month)".$adjust." ) 
;";
