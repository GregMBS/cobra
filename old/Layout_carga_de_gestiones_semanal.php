...
$queryayer="SELECT max(d_fech),year(max(d_fech)),month(max(d_fech)),day(max(d_fech)) FROM historia WHERE d_fech<curdate()-8 and c_cvge<>'Milt';";
...
where d_fech < curdate() and c_cvba='Credito Si' and d_fech>'".$ayer."';";
