...
$sQuery="CREATE temporary TABLE  `vencido` (
...
mysql_query( $sQuery, $con ) or die(mysql_error());
$sQuery="insert into vencido
select htemp.auto,htemp.cuenta,resumen.cliente,status_de_credito,
producto,subproducto,queue,
status_aarsa,nombre_deudor,n_prom,n_prom1,d_prom1,n_prom2,d_prom2,
folio,c_cvge,0,'',if(d_prom2>=curdate(),n_prom2,0),if(d_prom2>=curdate(),n_prom1,n_prom),0
from htemp
