...
saldo_total,cliente
FROM resumen 
where cliente='Surtidor del Hogar' and domicilio_deudor<>''
and id_cuenta not in 
(select c_cont from historia where month(d_fech)=12
and c_cvst='SE MANDO CARTA');";
...
$datebase = array("2009-12-30", "2009-12-30", "2009-12-30");
