...
where d_fech>'2009-08-10' and d_fech<=curdate()
and c_cvba='Credito Si' and (c_cvge<>'Milt' or status_de_credito='720s')
...
$C_HRIN=$answer[2];
$COBRADOR='';
if ($answer[3]=='270s') {$COBRADOR='1017';}
if ($answer[3]=='360s') {$COBRADOR='1018';}
if ($answer[3]=='720s') {$COBRADOR='1013';}
