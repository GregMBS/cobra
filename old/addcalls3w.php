...
$i++;
$TEL=$answersub[0];
$C_CVGEa=array("orlandoagustin","josefinajimenez","dinorarincon","elsaleonor");
$C_CVGE=$C_CVGEa[rand(0,3)];
//$C_CVGE=$answergable[3];
$C_CVST=$answersub[1];
$C_CVBA=$cliente;
$D_FECHa=array(date("Y-m-d", strtotime("-1 day")),date("Y-m-d", strtotime("-2 day")));
$D_FECH=$D_FECHa[rand(0,1)];
$C_OBSE=$answersub[2];
        $timebase=strtotime('07:00:00')+rand(0,11*60*60);
