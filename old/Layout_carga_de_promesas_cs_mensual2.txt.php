...
and concat(d_fech,' ',c_hrin)>now()-interval 24 hour
...
$j=1;
$k++;
if($answer[7]>1) {$cod='PS';$cn='002';} else {$cod='PP';$cn='001';}
$fechag=$answer[1];
$fechap=$answer[3];
...
"ADARSA  ','LH','".$cod."','".str_pad($fechag,8,"0",STR_PAD_LEFT)."','".
...
$j++;	
echo "600,2,'".str_pad($answer[0],25," ",STR_PAD_RIGHT)."','".
"ADARSA  ','LH','".$cod."','".str_pad($answer[9],8,"0",STR_PAD_LEFT)."','".
$cn."','".str_pad($j,3,"0",STR_PAD_LEFT)."','".
