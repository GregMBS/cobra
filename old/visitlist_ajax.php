...
$id_cuenta=mysql_real_escape_string($_COOKIE['id_cuenta']);
$space=' ';
$aColumns=array('c_cvst','d_fech','c_visit','left(c_obse1,50)','c_obse1','c_hrin');
$sTable='historia';
$sIndexColumn='auto';
	/* 
	 * Paging
	...
	if ( isset($_GET['sSearch']) && $_GET['sSearch'] != "" )
	{
		...
		$sWhere .= "  and c_cont=$id_cuenta and c_visit is not null and c_msge is null)";
		} else {
		$sWhere = "WHERE c_cont=$id_cuenta  and c_visit is not null and c_msge is null";
	}
