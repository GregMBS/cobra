...
$queryld="select year(last_day(curdate() - INTERVAL 1 month)),
...
sum(c_carg<>''),sum(c_carg='')
from historia where c_cvge='$c_cvge' and c_cont>0
and c_msge is null
and c_cniv is null and D_FECH=last_day(curdate() - interval 2 month) + interval $i day
group by D_FECH";
...
from historia WHERE c_cvge='".$c_cvge."'  and c_hrfi>c_hrin
and c_msge is null
