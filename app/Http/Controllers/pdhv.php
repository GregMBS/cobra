...
<html>
    <head>
        <title>Cuentas visitadas por <?php echo $gestor; ?> en <?php echo $fecha; ?></title>
        <meta charset="utf-8">
        ...
        <script src="https://cdn.datatables.net/1.10.12/css/dataTables.jqueryui.min.css" type="text/javascript"></script>
