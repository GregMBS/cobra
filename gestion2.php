...
$C_CVGE=mysql_real_escape_string($_REQUEST['C_CVGE']);
$C_CONT=mysql_real_escape_string($_REQUEST['C_CONT']);
$C_CVST=mysql_real_escape_string(urldecode($_REQUEST['C_CVST']));
$C_CVBA=mysql_real_escape_string(urldecode($_REQUEST['C_CVBA']));
$ACCION=mysql_real_escape_string($_REQUEST['ACCION']);
$C_MOTIV=mysql_real_escape_string($_REQUEST['MOTIV']);
$D_FECH=mysql_real_escape_string($_REQUEST['D_FECH']);
$C_HRIN=mysql_real_escape_string($_REQUEST['C_HRIN']);
$C_HRFI = date('H:i:s');
$C_TELE=mysql_real_escape_string($_REQUEST['C_TELE']);
$CUANDO=mysql_real_escape_string($_REQUEST['CUANDO']);
$CUENTA=mysql_real_escape_string($_REQUEST['CUENTA']);
$C_OBSE1=mysql_real_escape_string($_REQUEST['C_OBSE1']);
$C_OBSE2=mysql_real_escape_string($_REQUEST['C_OBSE2']);
$C_ATTE=mysql_real_escape_string($_REQUEST['C_ATTE']);
$C_CNP=mysql_real_escape_string($_REQUEST['C_CNP']);
$C_CONTAN=mysql_real_escape_string($_REQUEST['C_CONTAN']);
$C_CARG=utf8_encode(mysql_real_escape_string($_REQUEST['C_CARG']));
$C_CAMP=mysql_real_escape_string($_REQUEST['camp']);
$D_PROM1=mysql_real_escape_string($_REQUEST['D_PROM1']);
$D_PROM2=mysql_real_escape_string($_REQUEST['D_PROM2']);
...
$N_PROM1=mysql_real_escape_string($_REQUEST['N_PROM1']);
$N_PROM2=mysql_real_escape_string($_REQUEST['N_PROM2']);
$C_FREQ=mysql_real_escape_string($_REQUEST['C_FREQ']);
$C_NTEL=trim(mysql_real_escape_string($_REQUEST['C_NTEL']));
$C_NDIR=mysql_real_escape_string($_REQUEST['C_NCALLE'])." ".mysql_real_escape_string($_REQUEST['C_NCOL'])." ".mysql_real_escape_string($_REQUEST['C_NCIU']);
$C_EMAIL=mysql_real_escape_string($_REQUEST['C_EMAIL']);
...
"&C_VISIT=".$C_VISIT."&D_PROM1=".$D_PROM1."&D_PROM2=".$D_PROM2."&AUTH=".$AUTH.
...
//die($outstring);
$redirector = "Location: ".$uri."/resumen.php".$outstring;
header($redirector);
}
if ($flag==1) {
?>
