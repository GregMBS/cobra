    ...
    <html>
        <head>
            ...
            <style type="text/css">
                ...
                if (((preg_match('/[dv]o$/', $status_de_credito)) || ($id_cuenta == 0)) && ($mytipo <> 'admin')) {
                    ?> 
            ...
            <div id="buttonbox">
                <?php if ($id_cuenta == 0) { ?>
                    <form class="buttons" name="seg" method="get" action=
                        ...
                        <input type="submit" name="go" value="INTRO QUEUE"></form>
                <?php } ?>
                    ...
                    <form action="resumen.php" method="get">
                        ...
                        <select name="clientefilt" onChange="this.form.submit()">
                            ...
                            foreach ($resultfilt as $answerfilt) {
                                ?>
                                <option value="<?php echo $answerfilt['cliente']; ?>" <?php if (($cliente == $answerfilt['cliente']) && ($sdc == $answerfilt['sdc']) && ($cr == $answerfilt['queue'])) { ?> 
                                            selected='selected'
                                            <?php
                                        }
                    ...
                    <table summary="sdh extras">
                        ...
                        foreach ($resultextra as $answerextra) {
                            ...
                            <tr>
                                ...
                                <td><?php echo $answerextra['producto']; ?></td>
                                <td><?php echo number_format($answerextra['saldo_descuento_1'], 2); ?></td>
                                <td><?php echo number_format($answerextra['saldo_descuento_2'], 2); ?></td>
                            </tr>
                        <?php } ?>
                    </table>
                </div>
                    ...
                    <table summary="contables">
                        ...
                        <tr>
                            ...
                            <td><input type='text' name=descuento readonly='readonly' value='<?php
                                if ($saldo_descuento_1 > 0) {
                                    echo number_format(100 - ($saldo_descuento_2 / $saldo_descuento_1) * 100) . "%";
                                } else {
                                    echo number_format(100 - ($saldo_descuento_2 / ($saldo_total + 0.01)) * 100) . "%";
                                }
                                ?>'></td>
                        </tr>
                        <tr>
