...
$querygable="SELECT id_cuenta, numero_de_cuenta,tel_2,'beatriz',cliente
from resumen 
where (cliente='Provident') and tel_2+1>1
;";
...
$C_CVSTa=array('TEL OCUPADA O NO CONTESTA','MENSAJE EN CONTESTADORA','MENSAJE EN CONTESTADORA','MENSAJE EN CONTESTADORA');
$n=rand(0,4);
$C_CVST=$C_CVSTa[$n];
$C_OBSE1a=array('SE MARCA TEL '.$TEL.' Y NO CONTESTA',$TEL.' SE DEJA MSJ EN BUZON','SE DEJA MSJ EN BUZON '.$TEL,$TEL.' SE DEJA MSJ EN BUZON');
$C_OBSE1=$C_OBSE1a[$n];
$C_CVBA=$answergable[4];
$D_FECHa=array("2011-03-10","2011-03-11","2011-03-15","2011-03-16","2011-03-17","2011-03-18");
