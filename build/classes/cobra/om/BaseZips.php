...
/**
 * Base class that represents a row from the 'zips' table.
 *
 *
 *
 * @package    propel.generator.cobra.om
 */
abstract class BaseZips extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
     ...
     * @return Zips The current object (for fluent API support)
     */
    public function setEstadoDeudor($v)
    {
        ...
        if ($this->estado_deudor !== $v) {
            ...
            $this->modifiedColumns[] = ZipsPeer::ESTADO_DEUDOR;
        }
    ...
    public function setCiudadDeudor($v)
    {
        ...
        if ($this->ciudad_deudor !== $v) {
            ...
            $this->modifiedColumns[] = ZipsPeer::CIUDAD_DEUDOR;
        }
    ...
    public function setColoniaDeudor($v)
    {
        ...
        if ($this->colonia_deudor !== $v) {
            ...
            $this->modifiedColumns[] = ZipsPeer::COLONIA_DEUDOR;
        }
    ...
    public function setCpDeudor($v)
    {
        ...
        if ($this->cp_deudor !== $v) {
            $this->cp_deudor = $v;
            $this->modifiedColumns[] = ZipsPeer::CP_DEUDOR;
        }
    ...
    public function setAuto($v)
    {
        ...
        if ($this->auto !== $v) {
            $this->auto = $v;
            $this->modifiedColumns[] = ZipsPeer::AUTO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->cp_deudor = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->auto = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            $this->resetModified();
            ...
            return $startcol + 5; // 5 = ZipsPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Zips object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ZipsPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ZipsPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ZipsPeer::ESTADO_DEUDOR)) {
            $modifiedColumns[':p' . $index++]  = '`estado_deudor`';
        }
        if ($this->isColumnModified(ZipsPeer::CIUDAD_DEUDOR)) {
            $modifiedColumns[':p' . $index++]  = '`ciudad_deudor`';
        }
        if ($this->isColumnModified(ZipsPeer::COLONIA_DEUDOR)) {
            $modifiedColumns[':p' . $index++]  = '`colonia_deudor`';
        }
        if ($this->isColumnModified(ZipsPeer::CP_DEUDOR)) {
            $modifiedColumns[':p' . $index++]  = '`cp_deudor`';
        }
        if ($this->isColumnModified(ZipsPeer::AUTO)) {
            $modifiedColumns[':p' . $index++]  = '`auto`';
        }

        $sql = sprintf(
            'INSERT INTO `zips` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ZipsPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ZipsPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Zips'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Zips'][$this->getPrimaryKey()] = true;
        $keys = ZipsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getEstadoDeudor(),
            $keys[1] => $this->getCiudadDeudor(),
            $keys[2] => $this->getColoniaDeudor(),
            $keys[3] => $this->getCpDeudor(),
            $keys[4] => $this->getAuto(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[3], $arr)) $this->setCpDeudor($arr[$keys[3]]);
        if (array_key_exists($keys[4], $arr)) $this->setAuto($arr[$keys[4]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ZipsPeer::ESTADO_DEUDOR)) $criteria->add(ZipsPeer::ESTADO_DEUDOR, $this->estado_deudor);
        if ($this->isColumnModified(ZipsPeer::CIUDAD_DEUDOR)) $criteria->add(ZipsPeer::CIUDAD_DEUDOR, $this->ciudad_deudor);
        if ($this->isColumnModified(ZipsPeer::COLONIA_DEUDOR)) $criteria->add(ZipsPeer::COLONIA_DEUDOR, $this->colonia_deudor);
        if ($this->isColumnModified(ZipsPeer::CP_DEUDOR)) $criteria->add(ZipsPeer::CP_DEUDOR, $this->cp_deudor);
        if ($this->isColumnModified(ZipsPeer::AUTO)) $criteria->add(ZipsPeer::AUTO, $this->auto);
    ...
    {
        $criteria = new Criteria(ZipsPeer::DATABASE_NAME);
        $criteria->add(ZipsPeer::AUTO, $this->auto);
     ...
     * objects.
     *
     * @param object $copyObj An object of Zips (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Zips Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ZipsPeer::DEFAULT_STRING_FORMAT);
    }
