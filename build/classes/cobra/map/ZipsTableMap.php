...
/**
 * This class defines the structure of the 'zips' table.
 *
 *
 *
 ...
 */
class ZipsTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'cobra.map.ZipsTableMap';
    ...
    public function initialize()
    {
        // attributes
        $this->setName('zips');
        $this->setPhpName('Zips');
        $this->setClassname('Zips');
