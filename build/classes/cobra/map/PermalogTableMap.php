...
/**
 * This class defines the structure of the 'permalog' table.
 *
 *
 *
 ...
 */
class PermalogTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'cobra.map.PermalogTableMap';
    ...
    {
        // attributes
        $this->setName('permalog');
        $this->setPhpName('Permalog');
        $this->setClassname('Permalog');
