...
/**
 * This class defines the structure of the 'extradex' table.
 *
 *
 *
 ...
 */
class ExtradexTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'cobra.map.ExtradexTableMap';
    ...
    {
        // attributes
        $this->setName('extradex');
        $this->setPhpName('Extradex');
        $this->setClassname('Extradex');
