...
/**
 * This class defines the structure of the 'resumen' table.
 *
 *
 *
 ...
 */
class ResumenTableMap extends TableMap
{

    /**
     * The (dot-path) name of this class
     */
    const CLASS_NAME = 'cobra.map.ResumenTableMap';
    ...
    {
        // attributes
        $this->setName('resumen');
        $this->setPhpName('Resumen');
        $this->setClassname('Resumen');
        ...
        $this->addColumn('avapar', 'Avapar', 'VARCHAR', false, 255, null);
        ...
        $this->addColumn('domicilio_deudor_2', 'DomicilioDeudor2', 'VARCHAR', false, 255, null);
        $this->addColumn('frecuencia', 'Frecuencia', 'VARCHAR', false, 255, null);
        $this->addColumn('originacion', 'Originacion', 'VARCHAR', false, 255, null);
        $this->addColumn('sucursal_cliente', 'SucursalCliente', 'VARCHAR', false, 25, null);
        ...
        $this->addColumn('status_de_credito', 'StatusDeCredito', 'VARCHAR', false, 50, '');
        ...
        $this->addColumn('nss', 'Nss', 'VARCHAR', false, 11, null);
        ...
        $this->addColumn('nrpp', 'Nrpp', 'VARCHAR', false, 11, null);
        ...
        $this->addColumn('fecha_convenio', 'FechaConvenio', 'DATE', false, null, null);
