...
class CreateResumenTable extends Migration
{
     ...
     * @var string
     */
    public $set_schema_table = 'resumen';
    ...
    public function up()
    {
        ...
        Schema::create($this->set_schema_table, function (Blueprint $table) {
            ...
            $table->string('avapar')->nullable()->default(null);
            ...
            $table->string('status_de_credito', 50)->nullable()->default('');
            ...
            $table->string('nss', 11)->nullable()->default(null);
            ...
            $table->index(["status_de_credito"], 'statussort');

            $table->unique(["numero_de_cuenta"], 'cuenta');
        });
    }
