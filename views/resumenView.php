                        ...
                        foreach ($resultfilt as $answerfilt) {
                            ?>
                                <option value="<?php echo $answerfilt['cliente']; ?>" <?php
                                   if (($cliente == $answerfilt['cliente']) && ($sdc == $answerfilt['sdc']) && ($cr == $answerfilt['queue'])) {
                                       ?>
                                            selected='selected'
                            <?php
                        }
            ...
            <div class="clearbox">
                <UL class='tabs'>
                    ...
                    $liArray = array(
                        ...
                        'VISITA' => 'CAPTURA VISITA',
                        'HISTORIA' => 'HISTORIA'
                        );
                        foreach ($liArray as $key => $value) { ?>
                    <LI>
                        <A onClick='paging("<?php echo $key; ?>")'>
                            <?php echo $value; ?>
                        </A>
                    </LI>
                    <?php        
            ...
            <div class="togglebox" id="VISITA">
                <form action="resumen.php" method="get" id="capturaform" 
                    ...
                    <SELECT NAME="C_VH">
                        ...
                        for ($vh=0; $vh<24; $vh++) {
                        ?>
                        <OPTION VALUE=<?php echo $vh; ?>><?php echo $vh; ?></option>
                        <?php
                        }
                        ?>
                    </select>:
                    <SELECT NAME="C_VMN">
                        <?php 
                        for ($vm=0; $vm<60; $vm++) {
                            $vmh = str_pad($vm, 2, '0', STR_PAD_LEFT);
                        ?>
                        <OPTION VALUE='<?php echo $vmh; ?>'><?php echo $vmh; ?></option>
                        <?php
                        }
                        ?>
                    </select>
