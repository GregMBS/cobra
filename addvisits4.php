...
saldo_total,cliente,greatest(fecha_de_asignacion+interval 2 day,'2009-12-04') as fds,
fecha_de_ultimo_pago
FROM resumen 
where id_cuenta in (select c_cont from losconfs)
and id_cuenta not in 
(select c_cont from historia where c_cniv is not null)
...
$C_CVGE='edgar';
$C_VISIT='edgar';
$C_CVST='NOTIFICACION BAJO PUERTA';
$C_OBSE1='SE DEJE AVISE EN DOMICILIO';
