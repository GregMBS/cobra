...
$iDisplayStart  = intval(filter_input(INPUT_GET, 'iDisplayStart',
        FILTER_SANITIZE_NUMBER_INT));
$iDisplayLength = intval(filter_input(INPUT_GET, 'iDisplayLength',
        FILTER_SANITIZE_NUMBER_INT));
$iSortCol_0     = intval(filter_input(INPUT_GET, 'iSortCol_0',
        FILTER_SANITIZE_NUMBER_INT));
$iSortingCols   = intval(filter_input(INPUT_GET, 'iSortingCols',
        FILTER_SANITIZE_NUMBER_INT));
$aColumns       = array('tel', 'nombre', 'calle', 'colonia', 'ciudad', 'estado',
    'cp');
$sTable         = 'gray';
$sIndexColumn   = '1';
/*
...
if (isset($iSortCol_0)) {
    ...
    for ($i = 0; $i < $iSortingCols; $i++) {
        ...
        $bSortable = filter_input('bSortable_'.$iSortCol,
            FILTER_SANITIZE_NUMBER_INT);
        if ($bSortable == "true") {
