...
{
  if ((f.value===null)||(f.value==="")||(f.value===" ")||(f.value==='0')||(f.value==="0000-00-00"))
  {return false;}
}
...
if (validate_required(tf.C_TELE)===false)
  ...
  tf.C_TELE.style.backgroundColor="yellow";flag=1;}
//Must Have status
...
//        {alerttxt=alerttxt+'Monto de pago no es demasiado grande para PAGO PARCIAL\n';
//        tf.N_PAGO.style.backgroundColor="yellow";flag=1;}
...
//        {alerttxt=alerttxt+'Monto de pago no es demasiado grande para PAGO INCOMPLETO\n';
//        tf.N_PAGO.style.backgroundColor="yellow";flag=1;}
...
//			{alerttxt=alerttxt+'Promesas en el mes siguiente necesita autorización\n';flag=1;}
//date must be on or before the 16th (admins exempt)
//		if ((parseInt(dp1.substr(8),10)>16) && (parseInt(tf.D_FECH.value.substr(8),10)<15))
//			{alerttxt=alerttxt+'Promesas despues 15 del mes necesita autorización\n';flag=1;}
...
if (n1>0) {alertstr=alertstr+" Fecha de promisa 1: "+dp1+" ";}
if (n1>0) {alertstr=alertstr+" Monto de promisa 1: $"+n1+"\n";}
if (n2>0) {alertstr=alertstr+" Fecha de promisa 2: "+dp2+" ";}
if (n2>0) {alertstr=alertstr+" Monto de promisa 2: $"+n2+"\n";}
