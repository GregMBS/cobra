...
<html>
<head>
<title>Listado por Gestor</title>
...
<th><a href='<?php echo $_SERVER['PHP_SELF'] ?>?updown=<?php echo $updown ?>&ejecutivo_asignado_call_center=<?php echo $gestor ?>&capt=<?php echo $capt ?>&reorden=yes&go=numero_de_cuenta'>CUENTA</a></th>
<th><a href='<?php echo $_SERVER['PHP_SELF'] ?>?updown=<?php echo $updown ?>&ejecutivo_asignado_call_center=<?php echo $gestor ?>&capt=<?php echo $capt ?>&reorden=yes&go=nombre_deudor'>NOMBRE</a></th>
<th><a href='<?php echo $_SERVER['PHP_SELF'] ?>?updown=<?php echo $updown ?>&ejecutivo_asignado_call_center=<?php echo $gestor ?>&capt=<?php echo $capt ?>&reorden=yes&go=cliente'>CLIENTE</a></th>
<th><a href='<?php echo $_SERVER['PHP_SELF'] ?>?updown=<?php echo $updown ?>&ejecutivo_asignado_call_center=<?php echo $gestor ?>&capt=<?php echo $capt ?>&reorden=yes&go=monto'>MONTO PAGO</a></th>
<th><a href='<?php echo $_SERVER['PHP_SELF'] ?>?updown=<?php echo $updown ?>&ejecutivo_asignado_call_center=<?php echo $gestor ?>&capt=<?php echo $capt ?>&reorden=yes&go=saldo_total'>SALDO TOTAL</a></th>
<th><a href='<?php echo $_SERVER['PHP_SELF'] ?>?updown=<?php echo $updown ?>&ejecutivo_asignado_call_center=<?php echo $gestor ?>&capt=<?php echo $capt ?>&reorden=yes&go=n_prom'>MONTO PROMESA</a></th>
<th><a href='<?php echo $_SERVER['PHP_SELF'] ?>?updown=<?php echo $updown ?>&ejecutivo_asignado_call_center=<?php echo $gestor ?>&capt=<?php echo $capt ?>&reorden=yes&go=queue'>QUEUE</a></th>
<th><a href='<?php echo $_SERVER['PHP_SELF'] ?>?updown=<?php echo $updown ?>&ejecutivo_asignado_call_center=<?php echo $gestor ?>&capt=<?php echo $capt ?>&reorden=yes&go=ejecutivo_asignado_call_center'>GESTOR</a></th>
<th><a href='<?php echo $_SERVER['PHP_SELF'] ?>?updown=<?php echo $updown ?>&ejecutivo_asignado_call_center=<?php echo $gestor ?>&capt=<?php echo $capt ?>&reorden=yes&go=actualizado'>ACTUALIZADO</a></th>
</tr>
</thead>
<tbody>
<?php
