...
<body onLoad="paging('HISTORIA'); openSearch();" id="todos">
<div id="buttonbox">
    <?php if (true) { ?>
...
"resumenform">
    <div id="GENERAL">
        <table>
            <tr>
                <td>
                    <span class='formcapa' id='deudor'>Deudor</span><input type='text' size=50 style='width:7.1cm'
            ...
            <tr>
                <td>
                    ...
                    <span class='formcapa'>Numero de cuenta</span><input type='text' name=numero_de_cuenta
                                                                         ...
                                                                         ?>'><br>
                    <span class='formcapa'>Gestiones: <?php echo $countg; ?></span>&nbsp;<span class='formcapa'>Promesas: <?php echo $countpr; ?></span><span
                            class='formcapa'>Pagos: <?php echo $npagos; ?></span><br>
                    <span class='formcapa'>Status de la Cuenta</span><input type='text' name=status_aarsa
                                                                            readonly='readonly' value='<?php
...
";
    ...
    <div id="REFERENCIAS">
        <?php if (isset($nombre_deudor_alterno)) { ?>
            <span class='formcaps'>Aval</span><input type='text' name=nombre_deudor_alterno id="nombre_deudor_alterno"
                                                     readonly='readonly' value='<?php
        ...
        <?php if (isset($tel_1_alterno)) { ?>
            <span class='formcaps'>Tel 1</span><input type='text' name=tel_1_alterno id="tel_1_alterno"
                                                      readonly='readonly' value='<?php
        ...
        if (isset($tel_2_alterno)) {
            ?>
            <span class='formcaps'>Tel 2</span><input type='text' name=tel_2_alterno id="tel_2_alterno"
                                                      readonly='readonly' value='<?php
            if (isset($tel_2_alterno)) {
                echo $tel_2_alterno;
            }
        ...
        <?php if (isset($tel_1_ref_1)) { ?>
            <span class='formcaps'>Tel 1</span><input type='text' name=tel_1_ref_1 id="tel_1_ref_1" readonly='readonly'
                                                      value='<?php
        ...
        if (isset($tel_2_ref_1)) {
            ?>
            <span class='formcaps'>Tel 2</span><input type='text' name=tel_2_ref_1 id="tel_2_ref_1" readonly='readonly'
                                                      value='<?php
                                                      if (isset($tel_2_ref_1)) {
                                                          echo $tel_2_ref_1;
                                                      }
        ...
        <?php if (isset($tel_1_ref_2)) { ?>
            <span class='formcaps'>Tel 1</span><input type='text' name=tel_1_ref_2 id="tel_1_ref_2" readonly='readonly'
                                                      value='<?php
        ...
        if (isset($tel_2_ref_2)) {
            ?>
            <span class='formcaps'>Tel 2</span><input type='text' name=tel_2_ref_2 id="tel_2_ref_2" readonly='readonly'
                                                      value='<?php
                                                      if (isset($tel_2_ref_2)) {
                                                          echo $tel_2_ref_2;
                                                      }
        ...
        <?php if (isset($tel_1_ref_3)) { ?>
            <span class='formcaps'>Tel 1</span><input type='text' name=tel_1_ref_3 id="tel_1_ref_3" readonly='readonly'
                                                      value='<?php
        ...
        if (isset($tel_2_ref_3)) {
            ?>
            <span class='formcaps'>Tel 2</span><input type='text' name=tel_2_ref_3 id="tel_2_ref_3" readonly='readonly'
                                                      value='<?php
                                                      if (isset($tel_2_ref_3)) {
                                                          echo $tel_2_ref_3;
                                                      }
        ...
        <?php if (isset($tel_1_ref_4)) { ?>
            <span class='formcaps'>Tel 1</span><input type='text' name=tel_1_ref_4 id="tel_1_ref_4" readonly='readonly'
                                                      value='<?php
        ...
        if (isset($tel_2_ref_4)) {
            ?>
            <span class='formcaps'>Tel 2</span><input type='text' name=tel_2_ref_4 id="tel_2_ref_4" readonly='readonly'
                                                      value='<?php
                                                      if (isset($tel_2_ref_4)) {
                                                          echo $tel_2_ref_4;
                                                      }
            ...
            <table id="databox">
                ...
                <tr>
                    ...
                    <td><textarea rows="4" cols="50" name="C_OBSE1" id='C_OBSE1'
                                  onkeypress="tooLong(this);" onkeyup="valid(this, 'special');"
                ...
                <tr id="pagocapt" style="display:none">
                    ...
                    <td class="PrestamoFamiliar"><input class="PrestamoFamiliar" type="text" name="numero_sucursal"
                                                        id="numero_sucursal" value="" onmouseover='this.focus();'></td>
                </tr>
                <tr id="pagocapt2" style="display:none">
                    ...
                    <td class="PrestamoFamiliar"><input class="PrestamoFamiliar" type="text" name="nombre_sucursal"
                                                        id="nombre_sucursal" value="" onmouseover='this.focus();'></td>
                </tr>
                <tr>
                    <td>Motivadores</td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="N_PROM" readonly="readonly" style="background-color:#c0c0c0;" value="">
                    </td>
                    <td>Cant. de pago prometido anterior</td>
                    <td><input type="text" name="N_PROM_OLD" readonly="readonly" style="background-color:#c0c0c0;"
                               value="<?php
                               if (isset($N_PROM_OLD)) {
