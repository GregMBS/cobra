...
namespace  {
    ...
    /**
     * Class Route
     * @method Route|array middleware(string $middleware)
     * @method Route prefix(string $prefix)
     * @method Route namespace(string $namespace)
     * @method Route group(string $url)
     */
    ...
    /**
     * Class View
     * @method View with(string $label, $value)
     */
