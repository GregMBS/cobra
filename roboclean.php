...
$query = "truncate cobra.deadlines;
insert into cobra.deadlines select distinct right(c_tele,8) as c_tele
from cobra.historia 
...
and c_msge is null;
update robot.calllist,cobra.resumen
set turno=1000
...
update robot.calllist,cobra.deadlines
set turno=1000
