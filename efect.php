...
$go='';
$querymain = "select d_fech,c_cvge,d_prom,n_prom,fecha,monto,monto/n_prom*100 as effectividad,c_cvba from historia left join pagos on historia.cuenta=pagos.cuenta and c_cvba=cliente where c_cvst regexp 'promesa de' and c_visit is null order by c_cvge,d_fech,d_prom,fecha";
...
<html>
<head>
<title>Efectividad de Gestores</title>
