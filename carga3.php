        ...
        if (!empty($post['go'])) {
            ...
            if ($post['go'] == 'cargar') {
                ...
                if ($_FILES["file"]["error"] > 0) {
                    ...
                    ?>
                    <p>
                    <form action="carga3.php" method="post" name="clientepick">
            ...
            if ($post['go'] == 'clientepick') {
                ?>
                <p>
                <form action="carga3.php" method="post" name="assoc">
                    <?php
...
//                                           $position[$k] = $k;
            ...
            $querystart = "CREATE TABLE  `cobrajdlr`.`temp` (";
...
//            die($querystart.$queryend);
            ...
            if (($handle     = fopen($filename2, "r")) !== FALSE) {
                while (($data = fgetcsv($handle, 1000, ',', '"')) !== FALSE) {
                    if ($n == 0) {
                        $header    = $data;
                        $queryload = "INSERT INTO cobrajdlr.temp (".implode(",",
                                $header).") VALUES ";
                    }
                    if ($n > 0) {
