...
left join historia on c_cont=id_cuenta and c_visit is not null and c_msge is null
where status_de_credito not like '%o'  
".$clientestr." 
and estado_deudor in ('SLP','San Luis Potosi')
group BY cliente,status_de_credito,queue,numero_de_cuenta
    ;";
    $result = mysql_query($querymain) or die(mysql_error());
// Creating a workbook
$workbook = new Spreadsheet_Excel_Writer();

$filename="slp_".date('ymd').".xls";
...
<form action="slp.xls.php" method="get" name="queryparms">
