...
mora,h1.n_prom1+h1.n_prom2,datediff(h1.d_prom1,'1970-01-01'),h1.n_prom1,
datediff(h1.d_prom2,'1970-01-01'),h1.n_prom2,cuenta_concentradora_1,
...
and folios.cliente regexp 'Sales Finance'  and enviado=0
...
datediff(h1.d_prom1,'1970-01-01'),h1.n_prom1,cuenta_concentradora_1,
h1.d_fech,resumen.id_cuenta,
h1.c_cnp,folios.auto,h1.c_prom,h1.c_freq,
...
and h1.d_prom>last_day(curdate()-interval 1 month)
and h2.auto is null
and folios.cliente regexp 'Sales Finance' and enviado=0 group by folio
";
